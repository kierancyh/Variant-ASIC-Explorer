module rns_top_crt (Done,
 ...
 sky130_fd_sc_hd__inv_2 _1604_ (.A(\CU_state_dbg[0] ),
    ...
    .VPWR(VPWR),
    .Y(_0884_));
 sky130_fd_sc_hd__inv_2 _1605_ (.A(net294),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _1636_ (.A(\CU_state_dbg[2] ),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__nand2_4 _1637_ (.A(net86),
    .B(net87),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0913_));
 sky130_fd_sc_hd__and2_1 _1638_ (.A(net81),
    .B(_0913_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0914_));
 sky130_fd_sc_hd__nand2_1 _1639_ (.A(net80),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0915_));
 sky130_fd_sc_hd__a21boi_4 _1640_ (.A1(net80),
    .A2(net81),
    .B1_N(net86),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0916_));
 sky130_fd_sc_hd__and2_4 _1641_ (.A(net80),
    .B(_0887_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0917_));
 sky130_fd_sc_hd__and3b_1 _1642_ (.A_N(net86),
    .B(net81),
    .C(net80),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0918_));
 sky130_fd_sc_hd__o21ai_4 _1643_ (.A1(_0918_),
    .A2(_0916_),
    .B1(net79),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0919_));
 sky130_fd_sc_hd__or2_4 _1644_ (.A(net85),
    .B(_0916_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0920_));
 sky130_fd_sc_hd__and2_4 _1645_ (.A(_0919_),
    .B(_0920_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0921_));
 sky130_fd_sc_hd__nor2_1 _1646_ (.A(net86),
    .B(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _1647_ (.A_N(\A_reg[14] ),
    ...
    .VPWR(VPWR),
    .Y(_0923_));
 sky130_fd_sc_hd__nand2_1 _1648_ (.A(net81),
    .B(_0923_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _1649_ (.A(\A_reg[13] ),
    ...
    .VPWR(VPWR),
    .X(_0925_));
 sky130_fd_sc_hd__and3_1 _1650_ (.A(net81),
    .B(net86),
    .C(net85),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0926_));
 sky130_fd_sc_hd__nand3_1 _1651_ (.A(net97),
    .B(\A_reg[13] ),
    .C(\A_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o221a_1 _1653_ (.A1(_0915_),
    ...
    .VPWR(VPWR),
    .X(_0929_));
 sky130_fd_sc_hd__a41o_1 _1654_ (.A1(_0919_),
    .A2(_0914_),
    .A3(\A_reg[11] ),
    .A4(_0920_),
    .B1(_0929_),
    ...
    .VPWR(VPWR),
    .X(_0930_));
 sky130_fd_sc_hd__nand2_4 _1655_ (.A(_0930_),
    .B(_0921_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0931_));
 sky130_fd_sc_hd__a21o_1 _1656_ (.A1(_0931_),
    .A2(net189),
    .B1(_0914_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0932_));
 sky130_fd_sc_hd__o21ba_4 _1657_ (.A1(\A_reg[11] ),
    .A2(_0928_),
    .B1_N(_0930_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1658_ (.A(_0933_),
    ...
    .VPWR(VPWR),
    .Y(_0934_));
 sky130_fd_sc_hd__nand3_4 _1659_ (.A(\A_reg[10] ),
    .B(_0933_),
    .C(_0921_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0935_));
 sky130_fd_sc_hd__nand3_4 _1660_ (.A(_0914_),
    .B(net189),
    .C(_0931_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0936_));
 sky130_fd_sc_hd__a31oi_4 _1661_ (.A1(_0932_),
    .A2(_0936_),
    .A3(_0935_),
    .B1(_0889_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a311oi_2 _1666_ (.A1(_0932_),
    ...
    .VPWR(VPWR),
    .Y(_0942_));
 sky130_fd_sc_hd__o21ai_1 _1667_ (.A1(_0942_),
    .A2(_0941_),
    .B1(_0935_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0943_));
 sky130_fd_sc_hd__or3_4 _1668_ (.A(_0937_),
    .B(_0934_),
    .C(_0938_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0944_));
 sky130_fd_sc_hd__a21o_1 _1669_ (.A1(_0944_),
    .A2(_0943_),
    .B1(_0890_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _1670_ (.A(_0938_),
    ...
    .VPWR(VPWR),
    .Y(_0946_));
 sky130_fd_sc_hd__or3_4 _1671_ (.A(_0934_),
    .B(_0937_),
    .C(_0946_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1672_ (.A1(_0937_),
    ...
    .VPWR(VPWR),
    .Y(_0948_));
 sky130_fd_sc_hd__a21bo_4 _1673_ (.A1(net192),
    .A2(_0890_),
    .B1_N(_0945_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0949_));
 sky130_fd_sc_hd__o311a_4 _1674_ (.A1(_0891_),
    .A2(_0949_),
    .A3(_0940_),
    .B1(_0948_),
    .C1(_0947_),
 ...
 sky130_fd_sc_hd__o31a_1 _1675_ (.A1(_0891_),
    ...
    .VPWR(VPWR),
    .X(_0951_));
 sky130_fd_sc_hd__xnor2_2 _1676_ (.A(_0951_),
    .B(_0940_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0952_));
 sky130_fd_sc_hd__xnor2_4 _1677_ (.A(net195),
    .B(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0953_));
 sky130_fd_sc_hd__or3b_4 _1678_ (.A(_0892_),
    .B(_0949_),
    .C_N(_0953_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0954_));
 sky130_fd_sc_hd__a21oi_4 _1679_ (.A1(_0954_),
    .A2(_0952_),
    .B1(_0892_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1682_ (.A(\A_reg[6] ),
    ...
    .VPWR(VPWR),
    .X(_0958_));
 sky130_fd_sc_hd__a2bb2o_4 _1683_ (.A1_N(_0891_),
    .A2_N(_0950_),
    .B1(_0955_),
    .B2(_0953_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0959_));
 sky130_fd_sc_hd__xnor2_4 _1684_ (.A(_0959_),
    .B(net200),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0960_));
 sky130_fd_sc_hd__o21a_1 _1685_ (.A1(_0960_),
    .A2(_0958_),
    .B1(\A_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _1690_ (.A1(_0964_),
    ...
    .VPWR(VPWR),
    .X(_0966_));
 sky130_fd_sc_hd__or3_4 _1691_ (.A(_0961_),
    .B(_0957_),
    .C(_0962_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _1692_ (.A(_0894_),
    ...
    .VPWR(VPWR),
    .X(_0968_));
 sky130_fd_sc_hd__a21oi_4 _1693_ (.A1(_0967_),
    .A2(_0966_),
    .B1(_0894_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0969_));
 sky130_fd_sc_hd__o21ba_4 _1694_ (.A1(_0969_),
    .A2(net194),
    .B1_N(_0962_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0970_));
 sky130_fd_sc_hd__xnor2_2 _1695_ (.A(_0970_),
    .B(_0957_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0971_));
 sky130_fd_sc_hd__or2_4 _1696_ (.A(_0968_),
    .B(_0969_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _1697_ (.A(_0963_),
    ...
    .VPWR(VPWR),
    .Y(_0973_));
 sky130_fd_sc_hd__o21a_1 _1698_ (.A1(_0973_),
    .A2(_0971_),
    .B1(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0974_));
 sky130_fd_sc_hd__nor2_2 _1699_ (.A(_0974_),
    .B(net193),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0975_));
 sky130_fd_sc_hd__nor2_2 _1700_ (.A(_0975_),
    .B(_0968_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0976_));
 sky130_fd_sc_hd__xnor2_2 _1701_ (.A(_0976_),
    .B(_0963_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _1704_ (.A_N(_0972_),
    ...
    .VPWR(VPWR),
    .X(_0980_));
 sky130_fd_sc_hd__o21a_1 _1705_ (.A1(_0980_),
    .A2(_0977_),
    .B1(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _1706_ (.A(\A_reg[3] ),
    ...
    .VPWR(VPWR),
    .Y(_0982_));
 sky130_fd_sc_hd__or2_4 _1707_ (.A(_0982_),
    .B(net201),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1708_ (.A(_0983_),
    ...
    .VPWR(VPWR),
    .Y(_0984_));
 sky130_fd_sc_hd__o21ba_4 _1709_ (.A1(_0981_),
    .A2(net188),
    .B1_N(_0978_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0985_));
 sky130_fd_sc_hd__xnor2_4 _1710_ (.A(_0985_),
    .B(_0972_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _1711_ (.A1(_0979_),
    ...
    .VPWR(VPWR),
    .Y(_0987_));
 sky130_fd_sc_hd__nor2_2 _1712_ (.A(_0987_),
    .B(_0895_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _1713_ (.A1(\A_reg[2] ),
    ...
    .VPWR(VPWR),
    .X(_0989_));
 sky130_fd_sc_hd__o21ba_4 _1714_ (.A1(_0988_),
    .A2(net202),
    .B1_N(_0982_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _1718_ (.A1(\A_reg[1] ),
    ...
    .VPWR(VPWR),
    .X(_0994_));
 sky130_fd_sc_hd__xnor2_2 _1719_ (.A(_0994_),
    .B(net197),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _1721_ (.A(\A_reg[0] ),
    ...
    .VPWR(VPWR),
    .X(_0997_));
 sky130_fd_sc_hd__or2_4 _1722_ (.A(_0997_),
    .B(_0995_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _1724_ (.A(_0911_),
    ...
    .VPWR(VPWR),
    .Y(_1000_));
 sky130_fd_sc_hd__and2_4 _1725_ (.A(\A_reg[0] ),
    .B(_0998_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _1726_ (.A(_0911_),
    ...
    .VPWR(VPWR),
    .Y(_1002_));
 sky130_fd_sc_hd__a22o_1 _1727_ (.A1(net312),
    .A2(_0911_),
    .B1(_1002_),
    .B2(_0999_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__nand2_1 _1728_ (.A(net204),
    .B(_1001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1003_));
 sky130_fd_sc_hd__o21a_1 _1729_ (.A1(net203),
    .A2(_1001_),
    .B1(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1731_ (.A1(\A_reg[1] ),
    ...
    .VPWR(VPWR),
    .Y(_1005_));
 sky130_fd_sc_hd__a2bb2o_4 _1732_ (.A1_N(_0993_),
    .A2_N(_1005_),
    .B1(net203),
    .B2(_1001_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _1735_ (.A_N(\A_reg[15] ),
    ...
    .VPWR(VPWR),
    .X(_1008_));
 sky130_fd_sc_hd__o21ba_1 _1736_ (.A1(net81),
    .A2(_0913_),
    .B1_N(_1008_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1009_));
 sky130_fd_sc_hd__o221a_1 _1737_ (.A1(_0913_),
    .A2(net105),
    .B1(_1008_),
    .B2(\A_reg[12] ),
    .C1(net87),
    ...
    .VPWR(VPWR),
    .X(_1010_));
 sky130_fd_sc_hd__nor2_1 _1738_ (.A(net105),
    .B(_0923_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1011_));
 sky130_fd_sc_hd__or2_1 _1739_ (.A(net105),
    .B(_0923_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1012_));
 sky130_fd_sc_hd__o21ba_4 _1740_ (.A1(_1011_),
    .A2(_1010_),
    .B1_N(net85),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1013_));
 sky130_fd_sc_hd__a31o_1 _1741_ (.A1(net79),
    .A2(_1007_),
    .A3(_1012_),
    .B1(_1013_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1014_));
 sky130_fd_sc_hd__a311o_1 _1742_ (.A1(net79),
    .A2(_1007_),
    .A3(_1012_),
    .B1(\A_reg[11] ),
    .C1(_1013_),
    ...
    .VPWR(VPWR),
    .X(_1015_));
 sky130_fd_sc_hd__o22ai_2 _1743_ (.A1(net79),
    .A2(_1012_),
    .B1(_1013_),
    .B2(_1009_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1016_));
 sky130_fd_sc_hd__or3_1 _1744_ (.A(net85),
    .B(_1007_),
    .C(_1008_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1017_));
 sky130_fd_sc_hd__a21bo_1 _1745_ (.A1(net79),
    .A2(_1011_),
    .B1_N(_1017_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1018_));
 sky130_fd_sc_hd__a21o_1 _1746_ (.A1(_1016_),
    .A2(_1015_),
    .B1(_1018_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _1748_ (.A1(_1015_),
    ...
    .VPWR(VPWR),
    .Y(_1021_));
 sky130_fd_sc_hd__xnor2_4 _1749_ (.A(_0888_),
    .B(net180),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21boi_1 _1751_ (.A1(_0888_),
    ...
    .VPWR(VPWR),
    .Y(_1024_));
 sky130_fd_sc_hd__and2b_1 _1752_ (.A_N(net181),
    .B(_1018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1025_));
 sky130_fd_sc_hd__or2_4 _1753_ (.A(_1024_),
    .B(_1025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1026_));
 sky130_fd_sc_hd__o22a_1 _1754_ (.A1(_1022_),
    .A2(\A_reg[10] ),
    .B1(_1024_),
    .B2(_1025_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _1755_ (.A1(_1021_),
    ...
    .VPWR(VPWR),
    .Y(_1028_));
 sky130_fd_sc_hd__or3_4 _1756_ (.A(_0889_),
    .B(_1021_),
    .C(_1026_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1759_ (.A1(_1021_),
    ...
    .VPWR(VPWR),
    .Y(_1032_));
 sky130_fd_sc_hd__or2_4 _1760_ (.A(_1032_),
    .B(_1027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _1763_ (.A(_1034_),
    ...
    .VPWR(VPWR),
    .X(_1036_));
 sky130_fd_sc_hd__a311o_1 _1764_ (.A1(_1029_),
    .A2(_1028_),
    .A3(_0890_),
    .B1(_1034_),
    .C1(_1035_),
    ...
    .VPWR(VPWR),
    .X(_1037_));
 sky130_fd_sc_hd__a21oi_2 _1765_ (.A1(_1037_),
    .A2(_1033_),
    .B1(\A_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1038_));
 sky130_fd_sc_hd__or3_4 _1766_ (.A(\A_reg[9] ),
    .B(_1033_),
    .C(_1030_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a311o_1 _1769_ (.A1(\A_reg[9] ),
    ...
    .VPWR(VPWR),
    .X(_1042_));
 sky130_fd_sc_hd__or3_4 _1770_ (.A(\A_reg[9] ),
    .B(_1030_),
    .C(_1036_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1043_));
 sky130_fd_sc_hd__a21boi_4 _1771_ (.A1(_1043_),
    .A2(_1033_),
    .B1_N(_1039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1044_));
 sky130_fd_sc_hd__a21o_1 _1772_ (.A1(_1042_),
    .A2(_1040_),
    .B1(_1044_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _1775_ (.A_N(_1042_),
    ...
    .VPWR(VPWR),
    .Y(_1048_));
 sky130_fd_sc_hd__a21bo_1 _1776_ (.A1(_1045_),
    .A2(_0891_),
    .B1_N(_1041_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1049_));
 sky130_fd_sc_hd__and2_4 _1777_ (.A(_1048_),
    .B(_1049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1050_));
 sky130_fd_sc_hd__xnor2_2 _1778_ (.A(_1045_),
    .B(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _1780_ (.A1(_1048_),
    ...
    .VPWR(VPWR),
    .X(_1053_));
 sky130_fd_sc_hd__a21oi_4 _1781_ (.A1(_1053_),
    .A2(_1047_),
    .B1(\A_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a311o_1 _1784_ (.A1(\A_reg[7] ),
    ...
    .VPWR(VPWR),
    .X(_1057_));
 sky130_fd_sc_hd__o22ai_4 _1785_ (.A1(_1047_),
    .A2(_1052_),
    .B1(_1054_),
    .B2(net175),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1786_ (.A(_1050_),
    ...
    .VPWR(VPWR),
    .Y(_1059_));
 sky130_fd_sc_hd__mux2_2 _1787_ (.A0(_1052_),
    .A1(_1059_),
    .S(_1047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1060_));
 sky130_fd_sc_hd__a21oi_4 _1788_ (.A1(_1058_),
    .A2(_1057_),
    .B1(_1060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1061_));
 sky130_fd_sc_hd__nor2_1 _1789_ (.A(_1061_),
    .B(_1056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1062_));
 sky130_fd_sc_hd__mux2_4 _1790_ (.A0(_1062_),
    .A1(_1056_),
    .S(_1058_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1793_ (.A(_1064_),
    ...
    .VPWR(VPWR),
    .Y(_1066_));
 sky130_fd_sc_hd__xnor2_2 _1794_ (.A(_1061_),
    .B(\A_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _1795_ (.A(\A_reg[5] ),
    ...
    .VPWR(VPWR),
    .Y(_1068_));
 sky130_fd_sc_hd__o2bb2a_4 _1796_ (.A1_N(_1064_),
    .A2_N(_1065_),
    .B1(_1067_),
    .B2(\A_reg[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1069_));
 sky130_fd_sc_hd__o21ai_4 _1797_ (.A1(_1069_),
    .A2(_1063_),
    .B1(_0894_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1070_));
 sky130_fd_sc_hd__o31ai_4 _1798_ (.A1(_0894_),
    .A2(_1063_),
    .A3(_1066_),
    .B1(_1070_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1801_ (.A(_1066_),
    ...
    .VPWR(VPWR),
    .Y(_1074_));
 sky130_fd_sc_hd__mux2_2 _1802_ (.A0(_1074_),
    .A1(_1068_),
    .S(_1063_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1075_));
 sky130_fd_sc_hd__and2_4 _1803_ (.A(_1075_),
    .B(_1073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _1804_ (.A1(\A_reg[4] ),
    ...
    .VPWR(VPWR),
    .X(_1077_));
 sky130_fd_sc_hd__o21a_1 _1805_ (.A1(net176),
    .A2(_1077_),
    .B1(net184),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1078_));
 sky130_fd_sc_hd__xnor2_4 _1806_ (.A(_1076_),
    .B(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1079_));
 sky130_fd_sc_hd__or2_4 _1807_ (.A(_1079_),
    .B(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_1 _1809_ (.A1(\A_reg[4] ),
    ...
    .VPWR(VPWR),
    .Y(_1082_));
 sky130_fd_sc_hd__a21oi_4 _1810_ (.A1(_1080_),
    .A2(_1082_),
    .B1(_1078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1083_));
 sky130_fd_sc_hd__nor2_4 _1811_ (.A(\A_reg[3] ),
    .B(_1083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1084_));
 sky130_fd_sc_hd__xnor2_2 _1812_ (.A(_1083_),
    .B(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1085_));
 sky130_fd_sc_hd__nor2_2 _1813_ (.A(_1085_),
    .B(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1086_));
 sky130_fd_sc_hd__inv_2 _1814_ (.A(net177),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1087_));
 sky130_fd_sc_hd__xnor2_2 _1815_ (.A(net185),
    .B(_1084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1088_));
 sky130_fd_sc_hd__or2_4 _1816_ (.A(_1071_),
    .B(_1080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1089_));
 sky130_fd_sc_hd__a22o_4 _1817_ (.A1(_1082_),
    .A2(_1083_),
    .B1(_1089_),
    .B2(_1078_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1090_));
 sky130_fd_sc_hd__o21ba_4 _1818_ (.A1(_1088_),
    .A2(_1086_),
    .B1_N(_1090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1091_));
 sky130_fd_sc_hd__or2_4 _1819_ (.A(\A_reg[2] ),
    .B(_1091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1092_));
 sky130_fd_sc_hd__a22o_4 _1820_ (.A1(net178),
    .A2(_1090_),
    .B1(net179),
    .B2(_1092_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1822_ (.A(\A_reg[1] ),
    ...
    .VPWR(VPWR),
    .Y(_1095_));
 sky130_fd_sc_hd__or2_4 _1823_ (.A(_1094_),
    .B(\A_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _1825_ (.A0(_1097_),
    ...
    .VPWR(VPWR),
    .X(_1098_));
 sky130_fd_sc_hd__a21oi_4 _1826_ (.A1(_1096_),
    .A2(_1093_),
    .B1(_1098_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _1827_ (.A(\A_reg[1] ),
    ...
    .VPWR(VPWR),
    .X(_1100_));
 sky130_fd_sc_hd__xnor2_2 _1828_ (.A(_1099_),
    .B(\A_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1101_));
 sky130_fd_sc_hd__nor2_1 _1829_ (.A(_1101_),
    .B(\A_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_2 _1833_ (.A1(_1093_),
    ...
    .VPWR(VPWR),
    .Y(_1106_));
 sky130_fd_sc_hd__or2_4 _1834_ (.A(_1106_),
    .B(\A_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _1835_ (.A1(\A_reg[0] ),
    ...
    .VPWR(VPWR),
    .Y(_1108_));
 sky130_fd_sc_hd__o2bb2a_4 _1836_ (.A1_N(_1107_),
    .A2_N(_1108_),
    .B1(\a_r1[0] ),
    .B2(Encode_EN),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__xnor2_1 _1837_ (.A(net183),
    .B(_1107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1109_));
 sky130_fd_sc_hd__mux2_4 _1838_ (.A0(\a_r1[1] ),
    .A1(_1109_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1843_ (.A1(_1011_),
    ...
    .VPWR(VPWR),
    .Y(_1113_));
 sky130_fd_sc_hd__o21a_1 _1844_ (.A1(_0917_),
    .A2(net81),
    .B1(_0924_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1114_));
 sky130_fd_sc_hd__xor2_1 _1845_ (.A(net79),
    .B(_1114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1115_));
 sky130_fd_sc_hd__a211o_1 _1846_ (.A1(_1114_),
    .A2(net79),
    .B1(_1112_),
    .C1(_1011_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1116_));
 sky130_fd_sc_hd__and3_1 _1847_ (.A(_1116_),
    .B(_1113_),
    .C(\A_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1850_ (.A1(_1113_),
    ...
    .VPWR(VPWR),
    .Y(_1120_));
 sky130_fd_sc_hd__nor2_2 _1851_ (.A(_1120_),
    .B(_1118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1121_));
 sky130_fd_sc_hd__o21ai_1 _1852_ (.A1(_1121_),
    .A2(_1119_),
    .B1(\A_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1853_ (.A1(\A_reg[10] ),
    ...
    .VPWR(VPWR),
    .X(_1123_));
 sky130_fd_sc_hd__mux2_4 _1854_ (.A0(_1119_),
    .A1(_1121_),
    .S(_0889_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1124_));
 sky130_fd_sc_hd__o21ai_1 _1855_ (.A1(_1124_),
    .A2(_1123_),
    .B1(\A_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1860_ (.A1(\A_reg[8] ),
    ...
    .VPWR(VPWR),
    .X(_1130_));
 sky130_fd_sc_hd__mux2_4 _1861_ (.A0(_1127_),
    .A1(_1128_),
    .S(_0891_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1131_));
 sky130_fd_sc_hd__o21a_1 _1862_ (.A1(_1131_),
    .A2(_1130_),
    .B1(\A_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1132_));
 sky130_fd_sc_hd__mux2_4 _1863_ (.A0(_1132_),
    .A1(_0892_),
    .S(net276),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1133_));
 sky130_fd_sc_hd__o21ba_4 _1864_ (.A1(\A_reg[7] ),
    .A2(_1131_),
    .B1_N(_1132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1134_));
 sky130_fd_sc_hd__o21ai_2 _1865_ (.A1(_1134_),
    .A2(_1133_),
    .B1(\A_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a221o_1 _1868_ (.A1(_0893_),
    ...
    .VPWR(VPWR),
    .X(_1138_));
 sky130_fd_sc_hd__and2_4 _1869_ (.A(\A_reg[5] ),
    .B(_1138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1139_));
 sky130_fd_sc_hd__mux2_4 _1870_ (.A0(_1139_),
    .A1(_0894_),
    .S(net275),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1873_ (.A(_1142_),
    ...
    .VPWR(VPWR),
    .Y(_1143_));
 sky130_fd_sc_hd__o21ai_2 _1874_ (.A1(_1143_),
    .A2(_1140_),
    .B1(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1875_ (.A1(\A_reg[4] ),
    ...
    .VPWR(VPWR),
    .X(_1145_));
 sky130_fd_sc_hd__mux2_4 _1876_ (.A0(_1143_),
    .A1(_1140_),
    .S(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1146_));
 sky130_fd_sc_hd__o21ai_2 _1877_ (.A1(_1146_),
    .A2(_1145_),
    .B1(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1147_));
 sky130_fd_sc_hd__mux2_4 _1878_ (.A0(_1147_),
    .A1(\A_reg[3] ),
    .S(_1145_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1148_));
 sky130_fd_sc_hd__nor2_8 _1879_ (.A(net280),
    .B(_0895_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _1880_ (.A1(\A_reg[3] ),
    ...
    .VPWR(VPWR),
    .X(_1150_));
 sky130_fd_sc_hd__mux2_4 _1881_ (.A0(_1148_),
    .A1(_1150_),
    .S(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1151_));
 sky130_fd_sc_hd__nor2_8 _1882_ (.A(_1149_),
    .B(_1151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1152_));
 sky130_fd_sc_hd__mux2_4 _1883_ (.A0(_1149_),
    .A1(_0895_),
    .S(_1150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1153_));
 sky130_fd_sc_hd__o21ai_2 _1884_ (.A1(_1153_),
    .A2(_1152_),
    .B1(\A_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1154_));
 sky130_fd_sc_hd__mux2_4 _1885_ (.A0(_1154_),
    .A1(\A_reg[1] ),
    .S(_1152_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _1887_ (.A(\A_reg[0] ),
    ...
    .VPWR(VPWR),
    .Y(_1157_));
 sky130_fd_sc_hd__a21oi_4 _1888_ (.A1(_1157_),
    .A2(_1155_),
    .B1(_0886_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _1889_ (.A1(_0886_),
    ...
    .VPWR(VPWR),
    .Y(_1159_));
 sky130_fd_sc_hd__mux2_4 _1890_ (.A0(net324),
    .A1(_1159_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__o21a_1 _1891_ (.A1(_1158_),
    .A2(_1156_),
    .B1(_1157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1160_));
 sky130_fd_sc_hd__mux2_4 _1892_ (.A0(\a_r0[1] ),
    .A1(_1160_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1902_ (.A(net61),
    ...
    .VPWR(VPWR),
    .Y(_1167_));
 sky130_fd_sc_hd__nand2_1 _1903_ (.A(net55),
    .B(_1167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1168_));
 sky130_fd_sc_hd__a21boi_1 _1904_ (.A1(net58),
    .A2(net55),
    .B1_N(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1169_));
 sky130_fd_sc_hd__and3b_1 _1905_ (.A_N(net61),
    .B(net58),
    .C(net55),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1908_ (.A1(net54),
    ...
    .VPWR(VPWR),
    .Y(_1173_));
 sky130_fd_sc_hd__nand2_1 _1909_ (.A(\B_reg[13] ),
    .B(\B_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1174_));
 sky130_fd_sc_hd__and3_1 _1910_ (.A(\B_reg[13] ),
    .B(\B_reg[15] ),
    .C(\B_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _1912_ (.A_N(\B_reg[14] ),
    ...
    .VPWR(VPWR),
    .Y(_1177_));
 sky130_fd_sc_hd__and4b_1 _1913_ (.A_N(net58),
    .B(net55),
    .C(net54),
    .D(net61),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1178_));
 sky130_fd_sc_hd__a31o_1 _1914_ (.A1(net58),
    .A2(_1174_),
    .A3(_1176_),
    .B1(_1178_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _1939_ (.A(_0902_),
    ...
    .VPWR(VPWR),
    .Y(_1204_));
 sky130_fd_sc_hd__a31o_4 _1940_ (.A1(\B_reg[7] ),
    .A2(_1199_),
    .A3(_1204_),
    .B1(_1202_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1941_ (.A(\B_reg[7] ),
    ...
    .VPWR(VPWR),
    .Y(_1206_));
 sky130_fd_sc_hd__xnor2_4 _1942_ (.A(_0903_),
    .B(_1205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _1946_ (.A(_1199_),
    ...
    .VPWR(VPWR),
    .Y(_1211_));
 sky130_fd_sc_hd__a21o_1 _1947_ (.A1(_1211_),
    .A2(_1209_),
    .B1(_0904_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1964_ (.A1(\B_reg[4] ),
    ...
    .VPWR(VPWR),
    .X(_1229_));
 sky130_fd_sc_hd__a21oi_1 _1965_ (.A1(net205),
    .A2(_1229_),
    .B1(_1227_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1970_ (.A1(_1228_),
    ...
    .VPWR(VPWR),
    .X(_1235_));
 sky130_fd_sc_hd__xnor2_2 _1971_ (.A(net206),
    .B(_1235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _1989_ (.A0(\b_r2[1] ),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__xnor2_1 _1990_ (.A(net219),
    .B(_1244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _1992_ (.A1(\b_r2[2] ),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__or2_4 _1993_ (.A(\B_reg[13] ),
    .B(_1177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1255_));
 sky130_fd_sc_hd__o21ai_1 _1994_ (.A1(\B_reg[13] ),
    .A2(_1167_),
    .B1(\B_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1997_ (.A1(_1256_),
    ...
    .VPWR(VPWR),
    .X(_1259_));
 sky130_fd_sc_hd__xnor2_2 _1998_ (.A(_1259_),
    .B(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1260_));
 sky130_fd_sc_hd__o211ai_1 _1999_ (.A1(net56),
    .A2(_1259_),
    .B1(_1257_),
    .C1(_1176_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2001_ (.A(_1261_),
    ...
    .VPWR(VPWR),
    .Y(_1263_));
 sky130_fd_sc_hd__a2bb2o_4 _2002_ (.A1_N(\B_reg[11] ),
    .A2_N(_1260_),
    .B1(_1261_),
    .B2(_1262_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2023_ (.A(_1283_),
    ...
    .VPWR(VPWR),
    .Y(_1285_));
 sky130_fd_sc_hd__or3b_4 _2024_ (.A(\B_reg[8] ),
    .B(_1282_),
    .C_N(_1284_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _2027_ (.A0(_1288_),
    ...
    .VPWR(VPWR),
    .X(_1289_));
 sky130_fd_sc_hd__a21bo_4 _2028_ (.A1(_1287_),
    .A2(_1286_),
    .B1_N(_1289_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2029_ (.A(_1286_),
    ...
    .VPWR(VPWR),
    .Y(_1291_));
 sky130_fd_sc_hd__mux2_2 _2030_ (.A0(_1291_),
    .A1(_1286_),
    .S(_1287_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _2036_ (.A1(_0903_),
    ...
    .VPWR(VPWR),
    .X(_1298_));
 sky130_fd_sc_hd__a21oi_4 _2037_ (.A1(_1292_),
    .A2(_1298_),
    .B1(\B_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _2049_ (.A(\B_reg[6] ),
    ...
    .VPWR(VPWR),
    .Y(_1311_));
 sky130_fd_sc_hd__a2bb2o_4 _2050_ (.A1_N(\B_reg[5] ),
    .A2_N(_1311_),
    .B1(_1309_),
    .B2(_1308_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _2073_ (.A0(_1315_),
    ...
    .VPWR(VPWR),
    .X(_1335_));
 sky130_fd_sc_hd__a21oi_4 _2074_ (.A1(_1334_),
    .A2(_1333_),
    .B1(_1335_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _2075_ (.A(\B_reg[2] ),
    ...
    .VPWR(VPWR),
    .Y(_1337_));
 sky130_fd_sc_hd__xnor2_2 _2076_ (.A(net170),
    .B(_1337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2078_ (.A(\B_reg[1] ),
    ...
    .VPWR(VPWR),
    .Y(_1340_));
 sky130_fd_sc_hd__or2_4 _2079_ (.A(_1338_),
    .B(_1340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _2081_ (.A1(_1334_),
    ...
    .VPWR(VPWR),
    .Y(_1343_));
 sky130_fd_sc_hd__a21oi_4 _2082_ (.A1(_1341_),
    .A2(_1343_),
    .B1(\B_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _2090_ (.A1_N(_1350_),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__xnor2_1 _2091_ (.A(net146),
    .B(_1350_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _2095_ (.A0(\b_r1[2] ),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__nand2_1 _2096_ (.A(net55),
    .B(_1177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1355_));
 sky130_fd_sc_hd__o21a_1 _2097_ (.A1(_1355_),
    .A2(_1170_),
    .B1(_1255_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2098_ (.A(_0898_),
    ...
    .VPWR(VPWR),
    .X(_1357_));
 sky130_fd_sc_hd__or3b_4 _2099_ (.A(net61),
    .B(net55),
    .C_N(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1358_));
 sky130_fd_sc_hd__o21ai_2 _2100_ (.A1(net58),
    .A2(_1176_),
    .B1(_1358_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _2107_ (.A1(\B_reg[11] ),
    ...
    .VPWR(VPWR),
    .Y(_1366_));
 sky130_fd_sc_hd__mux2_4 _2108_ (.A0(_1363_),
    .A1(_0899_),
    .S(_1364_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2109_ (.A1(_1366_),
    ...
    .VPWR(VPWR),
    .Y(_1368_));
 sky130_fd_sc_hd__mux2_4 _2110_ (.A0(_1366_),
    .A1(_1367_),
    .S(\B_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2116_ (.A1(_1372_),
    ...
    .VPWR(VPWR),
    .Y(_1375_));
 sky130_fd_sc_hd__mux2_2 _2117_ (.A0(_1372_),
    .A1(_1374_),
    .S(\B_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _2123_ (.A1(_1380_),
    ...
    .VPWR(VPWR),
    .Y(_1382_));
 sky130_fd_sc_hd__mux2_2 _2124_ (.A0(_1380_),
    .A1(_1381_),
    .S(\B_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _2126_ (.A1(\B_reg[6] ),
    ...
    .VPWR(VPWR),
    .Y(_1385_));
 sky130_fd_sc_hd__mux2_2 _2127_ (.A0(_1383_),
    .A1(_1385_),
    .S(\B_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1386_));
 sky130_fd_sc_hd__nand2_4 _2128_ (.A(_1384_),
    .B(_1386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1387_));
 sky130_fd_sc_hd__mux2_4 _2129_ (.A0(\B_reg[5] ),
    .A1(_1384_),
    .S(_1385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1388_));
 sky130_fd_sc_hd__or2_4 _2130_ (.A(_0906_),
    .B(_1388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _2142_ (.A(_1400_),
    ...
    .VPWR(VPWR),
    .Y(_1401_));
 sky130_fd_sc_hd__mux2_4 _2143_ (.A0(_1399_),
    .A1(\B_reg[1] ),
    .S(_1398_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _2153_ (.A(_1408_),
    ...
    .VPWR(VPWR),
    .X(_1410_));
 sky130_fd_sc_hd__a31o_1 _2154_ (.A1(\A_reg[12] ),
    .A2(\A_reg[14] ),
    .A3(\A_reg[15] ),
    .B1(\A_reg[13] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _2157_ (.A1(_0887_),
    ...
    .VPWR(VPWR),
    .X(_1414_));
 sky130_fd_sc_hd__a2bb2o_4 _2158_ (.A1_N(_0923_),
    .A2_N(_0925_),
    .B1(_1414_),
    .B2(_1413_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2162_ (.A(_1417_),
    ...
    .VPWR(VPWR),
    .X(_1419_));
 sky130_fd_sc_hd__xnor2_4 _2163_ (.A(_0888_),
    .B(_1415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _2167_ (.A1_N(_1412_),
    ...
    .VPWR(VPWR),
    .X(_1424_));
 sky130_fd_sc_hd__a2bb2o_4 _2168_ (.A1_N(_1417_),
    .A2_N(_1418_),
    .B1(_1420_),
    .B2(\A_reg[10] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2170_ (.A1(_1414_),
    ...
    .VPWR(VPWR),
    .Y(_1427_));
 sky130_fd_sc_hd__a21o_4 _2171_ (.A1(_1425_),
    .A2(_1424_),
    .B1(_1427_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2173_ (.A1(_1419_),
    ...
    .VPWR(VPWR),
    .X(_1430_));
 sky130_fd_sc_hd__xnor2_4 _2174_ (.A(_0889_),
    .B(_1428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2175_ (.A(\A_reg[9] ),
    ...
    .VPWR(VPWR),
    .Y(_1432_));
 sky130_fd_sc_hd__and3_1 _2176_ (.A(_1428_),
    .B(_1420_),
    .C(\A_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2178_ (.A(_1433_),
    ...
    .VPWR(VPWR),
    .X(_1435_));
 sky130_fd_sc_hd__a2bb2o_4 _2179_ (.A1_N(_1433_),
    .A2_N(_1434_),
    .B1(\A_reg[9] ),
    .B2(_1431_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2182_ (.A1(_1424_),
    ...
    .VPWR(VPWR),
    .Y(_1439_));
 sky130_fd_sc_hd__a21o_4 _2183_ (.A1(_1436_),
    .A2(_1430_),
    .B1(_1439_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1440_));
 sky130_fd_sc_hd__xnor2_2 _2184_ (.A(_1440_),
    .B(_0890_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _2186_ (.A(\A_reg[9] ),
    ...
    .VPWR(VPWR),
    .Y(_1443_));
 sky130_fd_sc_hd__a21o_1 _2187_ (.A1(_1440_),
    .A2(\A_reg[9] ),
    .B1(_1431_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _2194_ (.A1(_1436_),
    ...
    .VPWR(VPWR),
    .X(_1451_));
 sky130_fd_sc_hd__a22o_4 _2195_ (.A1(_1450_),
    .A2(_1447_),
    .B1(_1451_),
    .B2(_1437_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _2196_ (.A(_1447_),
    ...
    .VPWR(VPWR),
    .X(_1453_));
 sky130_fd_sc_hd__mux2_2 _2197_ (.A0(_1453_),
    .A1(_1448_),
    .S(_1450_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1454_));
 sky130_fd_sc_hd__xnor2_4 _2198_ (.A(_1452_),
    .B(_0891_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1455_));
 sky130_fd_sc_hd__and3_1 _2199_ (.A(_1452_),
    .B(_1442_),
    .C(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _2201_ (.A(_1456_),
    ...
    .VPWR(VPWR),
    .Y(_1458_));
 sky130_fd_sc_hd__a211o_4 _2202_ (.A1(\A_reg[7] ),
    .A2(_1455_),
    .B1(_1457_),
    .C1(_1456_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _2204_ (.A1_N(_1453_),
    ...
    .VPWR(VPWR),
    .X(_1461_));
 sky130_fd_sc_hd__a21o_4 _2205_ (.A1(_1459_),
    .A2(_1461_),
    .B1(_1454_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1462_));
 sky130_fd_sc_hd__xnor2_2 _2206_ (.A(_1462_),
    .B(_0892_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1463_));
 sky130_fd_sc_hd__mux2_4 _2207_ (.A0(_1458_),
    .A1(_1459_),
    .S(_1462_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2210_ (.A(\A_reg[6] ),
    ...
    .VPWR(VPWR),
    .Y(_1467_));
 sky130_fd_sc_hd__and3_1 _2211_ (.A(_1462_),
    .B(_1455_),
    .C(\A_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1468_));
 sky130_fd_sc_hd__a21oi_2 _2212_ (.A1(_1462_),
    .A2(\A_reg[7] ),
    .B1(_1455_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2213_ (.A(_1468_),
    ...
    .VPWR(VPWR),
    .X(_1470_));
 sky130_fd_sc_hd__a2bb2o_4 _2214_ (.A1_N(_1468_),
    .A2_N(_1469_),
    .B1(\A_reg[6] ),
    .B2(_1463_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _2216_ (.A1(_1459_),
    ...
    .VPWR(VPWR),
    .X(_1473_));
 sky130_fd_sc_hd__a21bo_4 _2217_ (.A1(_1471_),
    .A2(_1466_),
    .B1_N(_1473_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2223_ (.A(\A_reg[5] ),
    ...
    .VPWR(VPWR),
    .Y(_1480_));
 sky130_fd_sc_hd__a2bb2o_4 _2224_ (.A1_N(_1475_),
    .A2_N(_1476_),
    .B1(_1478_),
    .B2(\A_reg[5] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2228_ (.A1(_1466_),
    ...
    .VPWR(VPWR),
    .X(_1485_));
 sky130_fd_sc_hd__a21o_4 _2229_ (.A1(_1481_),
    .A2(_1483_),
    .B1(_1485_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1486_));
 sky130_fd_sc_hd__xnor2_4 _2230_ (.A(_1486_),
    .B(_0894_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2231_ (.A(\A_reg[5] ),
    ...
    .VPWR(VPWR),
    .Y(_1488_));
 sky130_fd_sc_hd__and3_1 _2232_ (.A(_1486_),
    .B(_1479_),
    .C(\A_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2238_ (.A1(_1481_),
    ...
    .VPWR(VPWR),
    .Y(_1495_));
 sky130_fd_sc_hd__a21o_1 _2239_ (.A1(_1493_),
    .A2(_1491_),
    .B1(_1495_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _2241_ (.A(\A_reg[4] ),
    ...
    .VPWR(VPWR),
    .X(_1498_));
 sky130_fd_sc_hd__o32a_4 _2242_ (.A1(_1489_),
    .A2(_1490_),
    .A3(_1496_),
    .B1(_1497_),
    .B2(_1498_),
    ...
    .VPWR(VPWR),
    .X(_1499_));
 sky130_fd_sc_hd__xor2_2 _2243_ (.A(_1496_),
    .B(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2246_ (.A(_1501_),
    ...
    .VPWR(VPWR),
    .Y(_1503_));
 sky130_fd_sc_hd__a211o_1 _2247_ (.A1(_1500_),
    .A2(\A_reg[3] ),
    .B1(_1501_),
    .C1(_1502_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2248_ (.A1(_1491_),
    ...
    .VPWR(VPWR),
    .Y(_1505_));
 sky130_fd_sc_hd__a21oi_2 _2249_ (.A1(net88),
    .A2(_1493_),
    .B1(_1505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1506_));
 sky130_fd_sc_hd__a21oi_4 _2250_ (.A1(_1504_),
    .A2(_1499_),
    .B1(_1506_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1507_));
 sky130_fd_sc_hd__xnor2_4 _2251_ (.A(net98),
    .B(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2252_ (.A(\A_reg[2] ),
    ...
    .VPWR(VPWR),
    .Y(_1509_));
 sky130_fd_sc_hd__or3b_4 _2253_ (.A(_0896_),
    .B(_1507_),
    .C_N(net94),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2255_ (.A(_1510_),
    ...
    .VPWR(VPWR),
    .Y(_1512_));
 sky130_fd_sc_hd__a22o_1 _2256_ (.A1(_1508_),
    .A2(\A_reg[2] ),
    .B1(_1510_),
    .B2(_1511_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _2258_ (.A(\A_reg[3] ),
    ...
    .VPWR(VPWR),
    .X(_1515_));
 sky130_fd_sc_hd__o2bb2a_4 _2259_ (.A1_N(_1503_),
    .A2_N(net99),
    .B1(_1514_),
    .B2(_1515_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1516_));
 sky130_fd_sc_hd__a21oi_4 _2260_ (.A1(_1506_),
    .A2(net78),
    .B1(_1499_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1517_));
 sky130_fd_sc_hd__a21oi_4 _2261_ (.A1(net78),
    .A2(_1499_),
    .B1(_1517_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1518_));
 sky130_fd_sc_hd__a21o_1 _2262_ (.A1(net102),
    .A2(_1516_),
    .B1(_1518_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1519_));
 sky130_fd_sc_hd__a21oi_2 _2263_ (.A1(net89),
    .A2(_1518_),
    .B1(_1516_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1520_));
 sky130_fd_sc_hd__a21oi_2 _2264_ (.A1(net90),
    .A2(_1516_),
    .B1(_1520_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2266_ (.A1(_1509_),
    ...
    .VPWR(VPWR),
    .X(_1523_));
 sky130_fd_sc_hd__and3_1 _2267_ (.A(_1519_),
    .B(net106),
    .C(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1524_));
 sky130_fd_sc_hd__a21oi_2 _2268_ (.A1(_1519_),
    .A2(\A_reg[2] ),
    .B1(net106),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2269_ (.A(_1524_),
    ...
    .VPWR(VPWR),
    .X(_1526_));
 sky130_fd_sc_hd__xnor2_2 _2270_ (.A(_1519_),
    .B(_0895_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2271_ (.A(\A_reg[1] ),
    ...
    .VPWR(VPWR),
    .Y(_1528_));
 sky130_fd_sc_hd__a2bb2o_4 _2272_ (.A1_N(_1524_),
    .A2_N(_1525_),
    .B1(_1527_),
    .B2(\A_reg[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1529_));
 sky130_fd_sc_hd__a21o_1 _2273_ (.A1(_1529_),
    .A2(_1523_),
    .B1(_1521_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _2275_ (.A(\A_reg[1] ),
    ...
    .VPWR(VPWR),
    .Y(_1532_));
 sky130_fd_sc_hd__a21o_1 _2276_ (.A1(_1530_),
    .A2(\A_reg[1] ),
    .B1(net92),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2277_ (.A(_1532_),
    ...
    .VPWR(VPWR),
    .Y(_1534_));
 sky130_fd_sc_hd__a22o_1 _2278_ (.A1(_1531_),
    .A2(\A_reg[0] ),
    .B1(_1532_),
    .B2(_1533_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21boi_1 _2282_ (.A1(_1523_),
    ...
    .VPWR(VPWR),
    .Y(_1539_));
 sky130_fd_sc_hd__a21o_1 _2283_ (.A1(_1537_),
    .A2(_1535_),
    .B1(_1539_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1540_));
 sky130_fd_sc_hd__or2_4 _2284_ (.A(\A_reg[0] ),
    .B(_1540_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1541_));
 sky130_fd_sc_hd__nand2_4 _2285_ (.A(\A_reg[0] ),
    .B(_1540_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1542_));
 sky130_fd_sc_hd__and2_1 _2286_ (.A(net259),
    .B(_0911_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _2287_ (.A1(Encode_EN),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__xnor2_2 _2288_ (.A(_1542_),
    .B(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1544_));
 sky130_fd_sc_hd__mux2_4 _2289_ (.A0(\a_r3[1] ),
    .A1(_1544_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _2290_ (.A1(\A_reg[0] ),
    ...
    .VPWR(VPWR),
    .X(_1545_));
 sky130_fd_sc_hd__xor2_2 _2291_ (.A(_1545_),
    .B(_1534_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1546_));
 sky130_fd_sc_hd__mux2_4 _2292_ (.A0(\a_r3[2] ),
    .A1(_1546_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__a21o_1 _2293_ (.A1(net104),
    .A2(_1539_),
    .B1(_1537_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1547_));
 sky130_fd_sc_hd__a21oi_1 _2294_ (.A1(net104),
    .A2(_1537_),
    .B1(_0911_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _2388_ (.A1(_0131_),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__a21oi_4 _2389_ (.A1(net59),
    .A2(_0142_),
    .B1(_0907_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2400_ (.A1(_0148_),
    ...
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__nand2_1 _2401_ (.A(net60),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2426_ (.A(_0168_),
    ...
    .VPWR(VPWR),
    .Y(_0179_));
 sky130_fd_sc_hd__mux2_4 _2427_ (.A0(\b_r3[1] ),
    .A1(_0179_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _2429_ (.A(_0170_),
    ...
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__mux2_4 _2430_ (.A0(net262),
    .A1(_0181_),
    .S(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__and2_1 _2431_ (.A(net258),
    .B(_0911_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__o21ai_1 _2432_ (.A1(_0175_),
    .A2(_0171_),
    .B1(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__a31o_1 _2433_ (.A1(_0174_),
    .A2(Encode_EN),
    .A3(_0183_),
    .B1(_0182_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _2442_ (.A(_0191_),
    ...
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__nand2_1 _2443_ (.A(net325),
    .B(\a_r0[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__or2_4 _2444_ (.A(\a_r0[0] ),
    .B(\a_r0[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _2449_ (.A1(\a_r0[1] ),
    ...
    .VPWR(VPWR),
    .X(_0199_));
 sky130_fd_sc_hd__and4_1 _2450_ (.A(net326),
    .B(\b_r0[0] ),
    .C(\a_r0[1] ),
    .D(\b_r0[1] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _2454_ (.A1(_0198_),
    ...
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__or4b_4 _2455_ (.A(net328),
    .B(\OpSel_reg[0] ),
    .C(\OpSel_reg[1] ),
    .D_N(_0204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__a2bb2o_2 _2456_ (.A1_N(net328),
    .A2_N(_0186_),
    .B1(_0203_),
    .B2(_0204_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2457_ (.A(_0195_),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__a31o_1 _2458_ (.A1(net328),
    .A2(\b_r0[0] ),
    .A3(\OpSel_reg[1] ),
    .B1(\OpSel_reg[0] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2462_ (.A1(_0192_),
    ...
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__and4_1 _2463_ (.A(_0205_),
    .B(_0201_),
    .C(_0206_),
    .D(_0210_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2473_ (.A(\a_r1[0] ),
    ...
    .VPWR(VPWR),
    .Y(_0221_));
 sky130_fd_sc_hd__and2_4 _2474_ (.A(\b_r1[1] ),
    .B(\a_r1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__nand2_1 _2475_ (.A(net297),
    .B(net293),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _2479_ (.A(\a_r1[0] ),
    ...
    .VPWR(VPWR),
    .X(_0227_));
 sky130_fd_sc_hd__xnor2_1 _2480_ (.A(net294),
    .B(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2481_ (.A(_0216_),
    ...
    .VPWR(VPWR),
    .Y(_0229_));
 sky130_fd_sc_hd__and2_4 _2482_ (.A(_0216_),
    .B(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_1 _2483_ (.A1(_0187_),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__a21oi_4 _2484_ (.A1(_0885_),
    .A2(_0227_),
    .B1(_0230_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2492_ (.A(_0238_),
    ...
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__nor2_1 _2493_ (.A(net299),
    .B(net296),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _2515_ (.A1(_0260_),
    ...
    .VPWR(VPWR),
    .Y(_0263_));
 sky130_fd_sc_hd__nor2_2 _2516_ (.A(_0263_),
    .B(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a311o_1 _2518_ (.A1(\a_r1[2] ),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__or3b_4 _2519_ (.A(_0222_),
    .B(_0238_),
    .C_N(net301),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2523_ (.A1(_0224_),
    ...
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__nor2_1 _2524_ (.A(_0271_),
    .B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__mux2_4 _2525_ (.A0(_0270_),
    .A1(_0272_),
    .S(_0187_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2528_ (.A1(_0234_),
    ...
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__or2_4 _2529_ (.A(_0276_),
    .B(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__inv_2 _2530_ (.A(net303),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__o211ai_1 _2533_ (.A1(_0258_),
    ...
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__or2_4 _2534_ (.A(_0277_),
    .B(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__nand2_4 _2535_ (.A(_0281_),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2537_ (.A(_0237_),
    ...
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__or3b_4 _2538_ (.A(_0258_),
    .B(_0280_),
    .C_N(_0283_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2539_ (.A1(_0258_),
    ...
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__nand2_4 _2540_ (.A(_0286_),
    .B(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2542_ (.A(_0281_),
    ...
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__o21a_1 _2543_ (.A1(_0288_),
    .A2(_0285_),
    .B1(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0291_));
 sky130_fd_sc_hd__nor2_2 _2544_ (.A(_0291_),
    .B(_0237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _2545_ (.A1(_0237_),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__or2_4 _2546_ (.A(_0293_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _2557_ (.A1(\u_crt.r1[1] ),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__a21o_1 _2558_ (.A1(_0298_),
    .A2(_0294_),
    .B1(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__a21bo_1 _2559_ (.A1(_0304_),
    .A2(_0296_),
    .B1_N(_0234_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _2560_ (.A1(\u_crt.r1[2] ),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__and2_4 _2561_ (.A(\b_r2[1] ),
    .B(\a_r2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2562_ (.A(\a_r2[1] ),
    ...
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__and3_1 _2563_ (.A(_0306_),
    .B(\a_r2[2] ),
    .C(\b_r2[0] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2567_ (.A1(\a_r2[0] ),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__and2_4 _2568_ (.A(\a_r2[2] ),
    .B(\b_r2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__and2_4 _2569_ (.A(_0306_),
    .B(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_1 _2570_ (.A1(\a_r2[1] ),
    ...
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__or2_4 _2571_ (.A(_0314_),
    .B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _2572_ (.A_N(_0316_),
    ...
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__nand2_1 _2573_ (.A(net316),
    .B(\b_r2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2574_ (.A(_0307_),
    ...
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__xnor2_2 _2575_ (.A(_0311_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__and2_4 _2576_ (.A(_0319_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_2 _2581_ (.A_N(_0325_),
    ...
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__or2_4 _2582_ (.A(\a_r2[0] ),
    .B(\a_r2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0327_));
 sky130_fd_sc_hd__or2_4 _2583_ (.A(\a_r2[2] ),
    .B(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2584_ (.A(\a_r2[2] ),
    ...
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__a21o_1 _2585_ (.A1(_0329_),
    .A2(_0328_),
    .B1(net310),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _2590_ (.A1(_0318_),
    ...
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__nand3_1 _2591_ (.A(net310),
    .B(_0328_),
    .C(_0329_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _2595_ (.A(_0313_),
    ...
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__o211a_1 _2596_ (.A1(net317),
    .A2(\b_r2[1] ),
    .B1(net312),
    .C1(\b_r2[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__o21a_1 _2597_ (.A1(_0341_),
    .A2(net319),
    .B1(_0340_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _2599_ (.A(_0321_),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__o2bb2a_4 _2600_ (.A1_N(\OpSel_reg[0] ),
    .A2_N(_0338_),
    .B1(_0188_),
    .B2(_0344_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _2601_ (.A1(_0186_),
    ...
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__or3_1 _2602_ (.A(net322),
    .B(_0340_),
    .C(_0341_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o32a_1 _2606_ (.A1(_0188_),
    ...
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__a2bb2o_4 _2607_ (.A1_N(_0185_),
    .A2_N(_0351_),
    .B1(_0347_),
    .B2(_0343_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__nand3_4 _2608_ (.A(_0326_),
    .B(_0352_),
    .C(_0346_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _2611_ (.A(_0352_),
    ...
    .VPWR(VPWR),
    .Y(_0356_));
 sky130_fd_sc_hd__nand2_4 _2612_ (.A(_0353_),
    .B(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__inv_4 _2613_ (.A(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0358_));
 sky130_fd_sc_hd__nor2_1 _2614_ (.A(net312),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2619_ (.A(_0359_),
    ...
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__nand3_4 _2620_ (.A(net308),
    .B(_0358_),
    .C(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__a21o_1 _2621_ (.A1(_0353_),
    .A2(_0326_),
    .B1(_0364_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2623_ (.A1(_0326_),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__or3_1 _2624_ (.A(net312),
    .B(\b_r2[0] ),
    .C(_0187_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2627_ (.A1(_0326_),
    ...
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__or2_4 _2628_ (.A(_0371_),
    .B(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2629_ (.A(_0365_),
    ...
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__o211a_1 _2630_ (.A1(_0355_),
    .A2(net309),
    .B1(_0365_),
    .C1(_0353_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__o21ba_4 _2631_ (.A1(_0374_),
    .A2(_0373_),
    .B1_N(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__or2_4 _2632_ (.A(_0371_),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a32o_1 _2634_ (.A1(_0184_),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__nor2_1 _2635_ (.A(_0376_),
    .B(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0379_));
 sky130_fd_sc_hd__or2_4 _2636_ (.A(_0373_),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a32o_1 _2638_ (.A1(_0184_),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__mux2_4 _2639_ (.A0(_0373_),
    .A1(_0379_),
    .S(_0374_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _2655_ (.A(\a_r3[3] ),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__xnor2_1 _2656_ (.A(net258),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _2658_ (.A_N(_0393_),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__or3b_1 _2659_ (.A(net262),
    .B(_0393_),
    .C_N(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__xnor2_1 _2660_ (.A(net262),
    .B(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2667_ (.A(\OpSel_reg[0] ),
    ...
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__o211a_1 _2668_ (.A1(net258),
    .A2(_0395_),
    .B1(_0406_),
    .C1(\OpSel_reg[0] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _2676_ (.A1(_0384_),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__o211a_1 _2677_ (.A1(net259),
    .A2(_0186_),
    .B1(_0414_),
    .C1(_0416_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _2698_ (.A(\a_r3[0] ),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__a22o_1 _2699_ (.A1(\b_r3[3] ),
    .A2(\a_r3[0] ),
    .B1(\b_r3[2] ),
    .B2(\a_r3[1] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2701_ (.A(\b_r3[0] ),
    ...
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__xnor2_2 _2702_ (.A(_0441_),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2703_ (.A(_0428_),
    ...
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__or2_4 _2704_ (.A(_0428_),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__and2_4 _2705_ (.A(_0443_),
    .B(_0444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _2707_ (.A1(\a_r3[2] ),
    ...
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__and2_4 _2708_ (.A(_0446_),
    .B(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _2740_ (.A1(_0422_),
    ...
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__or4_4 _2741_ (.A(_0477_),
    .B(_0478_),
    .C(_0479_),
    .D(_0480_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2759_ (.A(_0483_),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__or4b_4 _2760_ (.A(_0484_),
    .B(_0495_),
    .C(_0496_),
    .D_N(_0493_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2764_ (.A1(_0469_),
    ...
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__or2_4 _2765_ (.A(_0504_),
    .B(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2767_ (.A(_0483_),
    ...
    .VPWR(VPWR),
    .Y(_0507_));
 sky130_fd_sc_hd__a21o_1 _2768_ (.A1(_0505_),
    .A2(_0502_),
    .B1(_0507_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2769_ (.A(_0499_),
    ...
    .VPWR(VPWR),
    .Y(_0509_));
 sky130_fd_sc_hd__a21oi_2 _2770_ (.A1(_0508_),
    .A2(_0499_),
    .B1(_0461_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _2771_ (.A(_0461_),
    ...
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__nor2_2 _2772_ (.A(_0511_),
    .B(_0510_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__and2_4 _2773_ (.A(_0436_),
    .B(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__xnor2_2 _2774_ (.A(net265),
    .B(net263),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0514_));
 sky130_fd_sc_hd__a21o_1 _2775_ (.A1(net274),
    .A2(_0509_),
    .B1(_0502_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _2776_ (.A1(_0499_),
    ...
    .VPWR(VPWR),
    .Y(_0516_));
 sky130_fd_sc_hd__o21a_1 _2777_ (.A1(_0514_),
    .A2(_0513_),
    .B1(_0516_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _2778_ (.A0(_0507_),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__nand2b_4 _2779_ (.A_N(_0517_),
    .B(_0518_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2783_ (.A(_0436_),
    ...
    .VPWR(VPWR),
    .Y(_0523_));
 sky130_fd_sc_hd__or2_4 _2784_ (.A(_0436_),
    .B(_0519_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0524_));
 sky130_fd_sc_hd__and2_4 _2785_ (.A(_0523_),
    .B(_0524_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0525_));
 sky130_fd_sc_hd__nand2_4 _2786_ (.A(_0420_),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0526_));
 sky130_fd_sc_hd__xor2_2 _2787_ (.A(net266),
    .B(_0523_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__nand2_4 _2788_ (.A(_0526_),
    .B(_0527_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0528_));
 sky130_fd_sc_hd__and2b_1 _2789_ (.A_N(net264),
    .B(_0513_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0529_));
 sky130_fd_sc_hd__o22a_1 _2790_ (.A1(net269),
    .A2(_0519_),
    .B1(_0520_),
    .B2(_0529_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0530_));
 sky130_fd_sc_hd__a21o_1 _2791_ (.A1(_0530_),
    .A2(_0528_),
    .B1(_0522_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _2792_ (.A(_0420_),
    ...
    .VPWR(VPWR),
    .Y(_0532_));
 sky130_fd_sc_hd__or2_4 _2793_ (.A(_0420_),
    .B(_0531_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0533_));
 sky130_fd_sc_hd__and2_4 _2794_ (.A(_0532_),
    .B(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0534_));
 sky130_fd_sc_hd__and2_4 _2795_ (.A(_0391_),
    .B(_0534_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _2803_ (.A(_0390_),
    ...
    .VPWR(VPWR),
    .Y(_0543_));
 sky130_fd_sc_hd__or2_4 _2804_ (.A(net270),
    .B(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2878_ (.A(\u_crt.r3[2] ),
    ...
    .VPWR(VPWR),
    .Y(_0566_));
 sky130_fd_sc_hd__and3_1 _2879_ (.A(\u_crt.r3[0] ),
    .B(\u_crt.r3[1] ),
    .C(\u_crt.r3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0567_));
 sky130_fd_sc_hd__and3_4 _2880_ (.A(\u_crt.r3[0] ),
    .B(\u_crt.r3[2] ),
    .C(\u_crt.r3[3] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2881_ (.A1(\u_crt.r3[3] ),
    ...
    .VPWR(VPWR),
    .Y(_0569_));
 sky130_fd_sc_hd__or3_4 _2882_ (.A(_0568_),
    .B(_0567_),
    .C(_0569_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_4 _2892_ (.A(\u_crt.r3[2] ),
    ...
    .VPWR(VPWR),
    .Y(_0580_));
 sky130_fd_sc_hd__nor2_1 _2893_ (.A(net130),
    .B(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0581_));
 sky130_fd_sc_hd__xnor2_4 _2894_ (.A(_0580_),
    .B(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2899_ (.A(_0578_),
    ...
    .VPWR(VPWR),
    .Y(_0587_));
 sky130_fd_sc_hd__xor2_2 _2900_ (.A(net130),
    .B(_0574_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0588_));
 sky130_fd_sc_hd__and2_4 _2901_ (.A(_0566_),
    .B(_0588_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2922_ (.A(_0589_),
    ...
    .VPWR(VPWR),
    .Y(_0610_));
 sky130_fd_sc_hd__o211a_4 _2923_ (.A1(_0609_),
    .A2(_0589_),
    .B1(_0610_),
    .C1(_0591_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _2924_ (.A(_0562_),
    ...
    .VPWR(VPWR),
    .X(_0612_));
 sky130_fd_sc_hd__xor2_2 _2925_ (.A(_0611_),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _2941_ (.A1(_0598_),
    ...
    .VPWR(VPWR),
    .Y(_0629_));
 sky130_fd_sc_hd__o21ba_4 _2942_ (.A1(_0566_),
    .A2(net130),
    .B1_N(_0574_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _2943_ (.A(_0566_),
    ...
    .VPWR(VPWR),
    .Y(_0631_));
 sky130_fd_sc_hd__or3_4 _2944_ (.A(_0581_),
    .B(_0630_),
    .C(_0631_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__or2_4 _2945_ (.A(_0632_),
    .B(_0564_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2946_ (.A(_0564_),
    ...
    .VPWR(VPWR),
    .Y(_0634_));
 sky130_fd_sc_hd__and2_4 _2947_ (.A(_0633_),
    .B(_0634_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2950_ (.A(_0615_),
    ...
    .VPWR(VPWR),
    .Y(_0638_));
 sky130_fd_sc_hd__or2_4 _2951_ (.A(_0637_),
    .B(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0639_));
 sky130_fd_sc_hd__or2_4 _2952_ (.A(_0604_),
    .B(_0639_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _2958_ (.A_N(_0645_),
    ...
    .VPWR(VPWR),
    .Y(_0646_));
 sky130_fd_sc_hd__a21oi_1 _2959_ (.A1(net130),
    .A2(_0574_),
    .B1(_0580_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _2967_ (.A(_0652_),
    ...
    .VPWR(VPWR),
    .Y(_0655_));
 sky130_fd_sc_hd__or2_4 _2968_ (.A(_0640_),
    .B(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2969_ (.A(_0640_),
    ...
    .VPWR(VPWR),
    .Y(_0657_));
 sky130_fd_sc_hd__and2_4 _2970_ (.A(_0656_),
    .B(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _2971_ (.A1(_0642_),
    ...
    .VPWR(VPWR),
    .Y(_0659_));
 sky130_fd_sc_hd__or3_4 _2972_ (.A(_0642_),
    .B(_0644_),
    .C(_0658_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0660_));
 sky130_fd_sc_hd__and2_4 _2973_ (.A(_0659_),
    .B(_0660_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _2974_ (.A_N(_0646_),
    ...
    .VPWR(VPWR),
    .Y(_0662_));
 sky130_fd_sc_hd__xnor2_4 _2975_ (.A(_0646_),
    .B(_0661_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor4_1 _3011_ (.A(_0567_),
    ...
    .VPWR(VPWR),
    .Y(_0699_));
 sky130_fd_sc_hd__or2_4 _3012_ (.A(_0579_),
    .B(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0700_));
 sky130_fd_sc_hd__o31a_1 _3013_ (.A1(_0568_),
    .A2(_0567_),
    .A3(_0569_),
    .B1(_0579_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3014_ (.A(_0699_),
    ...
    .VPWR(VPWR),
    .Y(_0702_));
 sky130_fd_sc_hd__or3_4 _3015_ (.A(_0604_),
    .B(_0699_),
    .C(_0701_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _3017_ (.A(_0563_),
    ...
    .VPWR(VPWR),
    .X(_0705_));
 sky130_fd_sc_hd__a21bo_4 _3018_ (.A1(_0703_),
    .A2(_0700_),
    .B1_N(_0705_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3019_ (.A(_0681_),
    ...
    .VPWR(VPWR),
    .Y(_0707_));
 sky130_fd_sc_hd__or2_4 _3020_ (.A(_0706_),
    .B(_0707_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3035_ (.A(_0622_),
    ...
    .VPWR(VPWR),
    .X(_0723_));
 sky130_fd_sc_hd__xnor2_2 _3036_ (.A(_0711_),
    .B(_0621_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3045_ (.A(_0673_),
    ...
    .VPWR(VPWR),
    .Y(_0733_));
 sky130_fd_sc_hd__xor2_1 _3046_ (.A(_0722_),
    .B(_0622_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _3049_ (.A1(_0623_),
    ...
    .VPWR(VPWR),
    .X(_0737_));
 sky130_fd_sc_hd__xor2_2 _3050_ (.A(_0724_),
    .B(_0723_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3057_ (.A(_0673_),
    ...
    .VPWR(VPWR),
    .X(_0745_));
 sky130_fd_sc_hd__or2_4 _3058_ (.A(_0733_),
    .B(_0745_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3061_ (.A(_0747_),
    ...
    .VPWR(VPWR),
    .X(_0749_));
 sky130_fd_sc_hd__xor2_2 _3062_ (.A(_0738_),
    .B(_0737_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3069_ (.A(_0754_),
    ...
    .VPWR(VPWR),
    .Y(_0757_));
 sky130_fd_sc_hd__xnor2_2 _3070_ (.A(_0750_),
    .B(_0749_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0758_));
 sky130_fd_sc_hd__or3_4 _3071_ (.A(_0754_),
    .B(_0756_),
    .C(_0758_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0759_));
 sky130_fd_sc_hd__a21o_1 _3072_ (.A1(_0759_),
    .A2(_0751_),
    .B1(_0742_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0760_));
 sky130_fd_sc_hd__a21oi_2 _3073_ (.A1(_0760_),
    .A2(_0741_),
    .B1(_0731_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0761_));
 sky130_fd_sc_hd__o21a_1 _3074_ (.A1(_0761_),
    .A2(_0730_),
    .B1(_0721_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0762_));
 sky130_fd_sc_hd__o21ai_4 _3075_ (.A1(_0720_),
    .A2(net124),
    .B1(_0698_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0763_));
 sky130_fd_sc_hd__a21oi_4 _3076_ (.A1(_0763_),
    .A2(_0697_),
    .B1(_0680_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0764_));
 sky130_fd_sc_hd__o21ai_4 _3077_ (.A1(_0764_),
    .A2(_0679_),
    .B1(_0663_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3082_ (.A(_0768_),
    ...
    .VPWR(VPWR),
    .X(_0770_));
 sky130_fd_sc_hd__a21oi_4 _3083_ (.A1(net129),
    .A2(_0662_),
    .B1(_0770_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0771_));
 sky130_fd_sc_hd__and3_1 _3084_ (.A(_0765_),
    .B(_0662_),
    .C(_0770_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0772_));
 sky130_fd_sc_hd__nor2_4 _3085_ (.A(_0772_),
    .B(_0771_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _3090_ (.A(_0768_),
    ...
    .VPWR(VPWR),
    .X(_0778_));
 sky130_fd_sc_hd__or3_4 _3091_ (.A(_0663_),
    .B(_0679_),
    .C(_0764_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0779_));
 sky130_fd_sc_hd__and2_4 _3092_ (.A(_0765_),
    .B(_0779_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3107_ (.A(_0786_),
    ...
    .VPWR(VPWR),
    .X(_0795_));
 sky130_fd_sc_hd__nor2_4 _3108_ (.A(_0784_),
    .B(_0795_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_4 _3110_ (.A(_0773_),
    ...
    .VPWR(VPWR),
    .X(_0798_));
 sky130_fd_sc_hd__nand2_8 _3111_ (.A(_0798_),
    .B(_0778_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3112_ (.A(_0777_),
    ...
    .VPWR(VPWR),
    .X(_0800_));
 sky130_fd_sc_hd__xnor2_2 _3113_ (.A(_0800_),
    .B(_0775_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3115_ (.A(_0753_),
    ...
    .VPWR(VPWR),
    .Y(_0803_));
 sky130_fd_sc_hd__xor2_4 _3116_ (.A(_0777_),
    .B(_0799_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0804_));
 sky130_fd_sc_hd__or2_4 _3117_ (.A(_0804_),
    .B(_0803_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3119_ (.A(_0778_),
    ...
    .VPWR(VPWR),
    .X(_0807_));
 sky130_fd_sc_hd__xnor2_2 _3120_ (.A(_0807_),
    .B(_0793_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0808_));
 sky130_fd_sc_hd__inv_2 _3121_ (.A(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3126_ (.A(_0788_),
    ...
    .VPWR(VPWR),
    .Y(_0814_));
 sky130_fd_sc_hd__and4_1 _3127_ (.A(_0810_),
    .B(_0790_),
    .C(_0813_),
    .D(_0814_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3133_ (.A(_0818_),
    ...
    .VPWR(VPWR),
    .Y(_0821_));
 sky130_fd_sc_hd__o21ai_4 _3134_ (.A1(_0817_),
    .A2(_0815_),
    .B1(_0821_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _3136_ (.A(_0823_),
    ...
    .VPWR(VPWR),
    .Y(_0824_));
 sky130_fd_sc_hd__nand2_1 _3137_ (.A(net113),
    .B(_0823_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0825_));
 sky130_fd_sc_hd__a21oi_4 _3138_ (.A1(_0822_),
    .A2(net131),
    .B1(_0823_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0826_));
 sky130_fd_sc_hd__inv_4 _3139_ (.A(_0826_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0827_));
 sky130_fd_sc_hd__mux2_4 _3140_ (.A0(_0825_),
    .A1(net113),
    .S(net132),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0828_));
 sky130_fd_sc_hd__nor2_4 _3141_ (.A(_0803_),
    .B(_0826_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0829_));
 sky130_fd_sc_hd__and2_4 _3142_ (.A(_0803_),
    .B(_0826_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0830_));
 sky130_fd_sc_hd__or2_4 _3143_ (.A(_0830_),
    .B(_0829_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0831_));
 sky130_fd_sc_hd__nor2_4 _3144_ (.A(_0561_),
    .B(_0831_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0832_));
 sky130_fd_sc_hd__nand2_1 _3145_ (.A(net135),
    .B(_0827_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0833_));
 sky130_fd_sc_hd__xnor2_2 _3146_ (.A(net118),
    .B(_0833_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0834_));
 sky130_fd_sc_hd__xnor2_2 _3147_ (.A(net137),
    .B(_0829_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0835_));
 sky130_fd_sc_hd__or3b_4 _3148_ (.A(_0832_),
    .B(_0835_),
    .C_N(_0834_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0836_));
 sky130_fd_sc_hd__nand2_1 _3149_ (.A(net117),
    .B(_0827_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3150_ (.A(_0790_),
    ...
    .VPWR(VPWR),
    .X(_0838_));
 sky130_fd_sc_hd__and2_4 _3151_ (.A(_0814_),
    .B(_0838_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3154_ (.A(_0841_),
    ...
    .VPWR(VPWR),
    .Y(_0842_));
 sky130_fd_sc_hd__a31o_1 _3155_ (.A1(net118),
    .A2(net135),
    .A3(_0827_),
    .B1(_0809_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _3159_ (.A_N(_0836_),
    ...
    .VPWR(VPWR),
    .X(_0847_));
 sky130_fd_sc_hd__o2bb2a_4 _3160_ (.A1_N(net123),
    .A2_N(_0827_),
    .B1(_0839_),
    .B2(_0813_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0848_));
 sky130_fd_sc_hd__or2_1 _3161_ (.A(net157),
    .B(_0826_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3162_ (.A(_0817_),
    ...
    .VPWR(VPWR),
    .Y(_0850_));
 sky130_fd_sc_hd__o21ai_1 _3163_ (.A1(net111),
    .A2(_0817_),
    .B1(_0827_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _3166_ (.A(_0852_),
    ...
    .VPWR(VPWR),
    .Y(_0854_));
 sky130_fd_sc_hd__o2111a_1 _3167_ (.A1(_0848_),
    .A2(_0847_),
    .B1(_0850_),
    .C1(_0852_),
    .D1(_0853_),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3168_ (.A1_N(_0818_),
    ...
    .VPWR(VPWR),
    .X(_0856_));
 sky130_fd_sc_hd__or2_4 _3169_ (.A(_0856_),
    .B(_0855_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0857_));
 sky130_fd_sc_hd__and2_4 _3170_ (.A(_0857_),
    .B(_0828_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3171_ (.A(_0561_),
    ...
    .VPWR(VPWR),
    .X(_0859_));
 sky130_fd_sc_hd__nor2_4 _3172_ (.A(_0561_),
    .B(_0858_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_2 _3174_ (.A1(_0912_),
    ...
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__xnor2_1 _3175_ (.A(_0860_),
    .B(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0862_));
 sky130_fd_sc_hd__mux2_4 _3176_ (.A0(\X_crt[1] ),
    .A1(_0862_),
    .S(CRT_Start),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__or2_4 _3177_ (.A(_0832_),
    .B(_0858_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0863_));
 sky130_fd_sc_hd__nor2_4 _3178_ (.A(_0835_),
    .B(_0863_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22a_1 _3180_ (.A1(\X_crt[2] ),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__or2_4 _3181_ (.A(_0834_),
    .B(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0866_));
 sky130_fd_sc_hd__or2_4 _3182_ (.A(_0836_),
    .B(_0858_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3185_ (.A(_0837_),
    ...
    .VPWR(VPWR),
    .Y(_0869_));
 sky130_fd_sc_hd__or2_4 _3186_ (.A(net115),
    .B(_0867_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _3187_ (.A1(_0867_),
    ...
    .VPWR(VPWR),
    .Y(_0871_));
 sky130_fd_sc_hd__o2bb2a_4 _3188_ (.A1_N(_0870_),
    .A2_N(_0871_),
    .B1(\X_crt[4] ),
    .B2(CRT_Start),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _3192_ (.A0(\X_crt[6] ),
    ...
    .VPWR(VPWR),
    .X(_0874_));
 sky130_fd_sc_hd__mux2_4 _3193_ (.A0(_0842_),
    .A1(_0874_),
    .S(_0873_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__o21ba_4 _3194_ (.A1(net121),
    .A2(_0848_),
    .B1_N(_0858_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0875_));
 sky130_fd_sc_hd__nor2_4 _3195_ (.A(net122),
    .B(_0858_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3196_ (.A(_0848_),
    ...
    .VPWR(VPWR),
    .Y(_0877_));
 sky130_fd_sc_hd__mux2_4 _3197_ (.A0(\X_crt[7] ),
    .A1(_0877_),
    .S(CRT_Start),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _3202_ (.A1(_0912_),
    ...
    .VPWR(VPWR),
    .Y(_0881_));
 sky130_fd_sc_hd__mux2_2 _3203_ (.A0(_0854_),
    .A1(_0881_),
    .S(_0879_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_1 input8 (.A(A_in[1]),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__buf_1 input9 (.A(A_in[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkinv_4 clkload6 (.A(clknet_3_6__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_2 split1 (.A(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__buf_4 split2 (.A(\B_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__buf_1 split3 (.A(\B_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer4 (.A(\B_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__clkbuf_2 split5 (.A(\B_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer6 (.A(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__buf_4 split8 (.A(\B_reg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(net62),
    ...
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__buf_2 rebuffer11 (.A(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer24 (.A(_1504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__clkbuf_2 rebuffer25 (.A(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__clkbuf_4 split26 (.A(net85),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__buf_8 split27 (.A(net87),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__buf_6 split28 (.A(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer29 (.A(_1531_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__clkbuf_2 rebuffer30 (.A(net82),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer31 (.A(_1486_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__buf_1 split32 (.A(\A_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__buf_8 split33 (.A(net103),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__buf_8 split34 (.A(\A_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer35 (.A(_1491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer36 (.A(net91),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer37 (.A(net91),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer38 (.A(_1513_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer39 (.A(_1527_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer40 (.A(_1518_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer41 (.A(_1500_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer42 (.A(net94),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer43 (.A(_1463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__buf_1 rebuffer44 (.A(\A_reg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__buf_6 rebuffer45 (.A(net101),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer46 (.A(_1507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net99));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer47 (.A(_1507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__clkbuf_2 rebuffer48 (.A(_1507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__clkbuf_1 rebuffer49 (.A(_1513_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__buf_6 rebuffer50 (.A(\A_reg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__clkbuf_2 rebuffer51 (.A(_1535_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__buf_6 split52 (.A(\A_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer53 (.A(net108),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer54 (.A(net108),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer55 (.A(_1508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer58 (.A(_0815_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer59 (.A(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer60 (.A(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer61 (.A(_0808_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer62 (.A(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer63 (.A(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer64 (.A(_0810_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer65 (.A(_0801_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__buf_6 rebuffer66 (.A(_0864_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__buf_6 rebuffer67 (.A(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer68 (.A(_0847_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer69 (.A(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer70 (.A(_0815_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__buf_6 rebuffer71 (.A(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer72 (.A(_0760_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__buf_1 rebuffer73 (.A(_0771_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__buf_1 rebuffer74 (.A(_0822_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__clkbuf_2 rebuffer75 (.A(_0762_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__buf_6 rebuffer76 (.A(_0765_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__buf_8 rebuffer77 (.A(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer78 (.A(_0773_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer79 (.A(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer80 (.A(_0799_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer81 (.A(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net134));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer82 (.A(_0805_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer83 (.A(_0831_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer84 (.A(_0804_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net137));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer93 (.A(_1345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer94 (.A(_1318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer103 (.A(_0759_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net156));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer104 (.A(_0815_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net157));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer117 (.A(_1332_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net170));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer122 (.A(net182),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net175));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer123 (.A(_1072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net176));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer124 (.A(_1086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net177));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer125 (.A(net177),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net178));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer126 (.A(_1085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net179));
 sky130_fd_sc_hd__buf_6 rebuffer127 (.A(_1019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net180));
 sky130_fd_sc_hd__buf_1 rebuffer128 (.A(_1015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net181));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer129 (.A(_1051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net182));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer130 (.A(_1101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net183));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer131 (.A(_1073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net184));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer132 (.A(net187),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net185));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer134 (.A(_1079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net187));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer135 (.A(_0974_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net188));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer136 (.A(_0919_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net189));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer137 (.A(_0955_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net190));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer138 (.A(net190),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net191));
 sky130_fd_sc_hd__clkbuf_2 rebuffer139 (.A(_0943_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net192));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer140 (.A(_0969_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net193));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer141 (.A(_0961_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net194));
 sky130_fd_sc_hd__buf_6 rebuffer142 (.A(_0950_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net195));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer143 (.A(_0977_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net196));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer144 (.A(_0983_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net197));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer145 (.A(net199),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net198));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer146 (.A(_0988_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net199));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer147 (.A(_0949_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net200));
 sky130_fd_sc_hd__buf_1 rebuffer148 (.A(_0981_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net201));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer149 (.A(net201),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net202));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer150 (.A(_0996_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net203));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer151 (.A(net203),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net204));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer152 (.A(_1223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net205));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer153 (.A(net205),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net206));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer165 (.A(_1240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net218));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer166 (.A(net218),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net219));
 sky130_fd_sc_hd__dlymetal6s2s_1 split205 (.A(\b_r3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net258));
 sky130_fd_sc_hd__clkbuf_2 split206 (.A(\a_r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net259));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer207 (.A(\b_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net260));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer208 (.A(net260),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net261));
 sky130_fd_sc_hd__clkbuf_2 split209 (.A(\b_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net262));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer210 (.A(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net263));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer211 (.A(net263),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net264));
 sky130_fd_sc_hd__clkbuf_2 rebuffer212 (.A(_0510_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net265));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer213 (.A(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net266));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer214 (.A(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net267));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer215 (.A(net273),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net268));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer216 (.A(net268),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net269));
 sky130_fd_sc_hd__buf_6 rebuffer217 (.A(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net270));
 sky130_fd_sc_hd__buf_6 rebuffer218 (.A(net270),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net271));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer219 (.A(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net272));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer220 (.A(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net273));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer221 (.A(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net274));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer222 (.A(net283),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net275));
 sky130_fd_sc_hd__buf_1 rebuffer223 (.A(_1130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net276));
 sky130_fd_sc_hd__buf_6 rebuffer224 (.A(net278),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net277));
 sky130_fd_sc_hd__buf_6 rebuffer225 (.A(_1155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net278));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer226 (.A(_1138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net279));
 sky130_fd_sc_hd__buf_6 rebuffer227 (.A(_1148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net280));
 sky130_fd_sc_hd__clkbuf_1 rebuffer228 (.A(_1128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net281));
 sky130_fd_sc_hd__buf_1 rebuffer229 (.A(_1123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net282));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer230 (.A(_1137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net283));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer240 (.A(\b_r1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net293));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer241 (.A(net293),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net294));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer242 (.A(net294),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net295));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer243 (.A(net294),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net296));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer244 (.A(\a_r1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net297));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer245 (.A(net297),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net298));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer246 (.A(net297),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net299));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer247 (.A(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net300));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer248 (.A(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net301));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer249 (.A(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net302));
 sky130_fd_sc_hd__buf_2 rebuffer250 (.A(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net303));
 sky130_fd_sc_hd__buf_1 rebuffer251 (.A(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net304));
 sky130_fd_sc_hd__buf_6 rebuffer255 (.A(net323),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net308));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer256 (.A(net308),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net309));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer257 (.A(\b_r2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net310));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer258 (.A(net312),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net311));
 sky130_fd_sc_hd__clkbuf_2 split259 (.A(\a_r2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net312));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer260 (.A(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net313));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer261 (.A(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net314));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer262 (.A(net314),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net315));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer263 (.A(\a_r2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net316));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer264 (.A(\a_r2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net317));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer265 (.A(net317),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net318));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer266 (.A(net321),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net319));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer267 (.A(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net320));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer268 (.A(net322),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net321));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer269 (.A(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net322));
 sky130_fd_sc_hd__clkbuf_1 rebuffer270 (.A(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net323));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer271 (.A(\a_r0[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net324));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer272 (.A(\a_r0[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net325));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer273 (.A(\a_r0[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net326));
 sky130_fd_sc_hd__buf_1 rebuffer274 (.A(net326),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net327));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer275 (.A(net326),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net328));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer276 (.A(net328),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_input16_A (.DIODE(A_in[9]),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1829__B (.DIODE(\A_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1834__B (.DIODE(\A_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2284__A (.DIODE(\A_reg[0] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2278__A2 (.DIODE(\A_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1606__A (.DIODE(\A_reg[0] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1754__A2 (.DIODE(\A_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2176__C (.DIODE(\A_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1609__A (.DIODE(\A_reg[10] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1847__C (.DIODE(\A_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1654__A3 (.DIODE(\A_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1742__B1 (.DIODE(\A_reg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1608__A (.DIODE(\A_reg[11] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split52_A (.DIODE(\A_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1649__A (.DIODE(\A_reg[13] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1828__B (.DIODE(\A_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1823__B (.DIODE(\A_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2276__A2 (.DIODE(\A_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1819__A (.DIODE(\A_reg[2] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1813__B (.DIODE(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2268__A2 (.DIODE(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2267__C (.DIODE(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2256__A2 (.DIODE(\A_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1615__A (.DIODE(\A_reg[2] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1807__B (.DIODE(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1812__B (.DIODE(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2251__B (.DIODE(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2247__A2 (.DIODE(\A_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1616__A (.DIODE(\A_reg[3] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1806__B (.DIODE(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2243__B (.DIODE(\A_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1698__B1 (.DIODE(\A_reg[4] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1794__B (.DIODE(\A_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1784__B1 (.DIODE(\A_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1613__A (.DIODE(\A_reg[6] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2212__A2 (.DIODE(\A_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2211__C (.DIODE(\A_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1612__A (.DIODE(\A_reg[7] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1677__B (.DIODE(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1778__B (.DIODE(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1769__B1 (.DIODE(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2199__C (.DIODE(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1611__A (.DIODE(\A_reg[8] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2187__A2 (.DIODE(\A_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1635__Y (.DIODE(CRT_Start),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2433__A2 (.DIODE(Encode_EN),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__2437__X (.DIODE(_0187_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2600__B1 (.DIODE(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1836__B1 (.DIODE(\a_r1[0] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2699__A2 (.DIODE(\a_r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split206_A (.DIODE(\a_r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__2289__A0 (.DIODE(\a_r3[1] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__3234__Q (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2723__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2707__A1 (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2706__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2689__A2 (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2684__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2683__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2682__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2657__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2653__A (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2292__A0 (.DIODE(\a_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1844__A2 (.DIODE(net81),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1650__A (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1642__B (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1736__A1 (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1640__A2 (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1639__B (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1638__A (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1648__A (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2847__A1 (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split28_X (.DIODE(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1737__A2 (.DIODE(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1738__A (.DIODE(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1739__A (.DIODE(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split28_A (.DIODE(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1734__A2 (.DIODE(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split52_X (.DIODE(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2678__C (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2675__B2 (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2646__B (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2677__A1 (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2649__A2 (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2286__A (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split206_X (.DIODE(net259),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(net13),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_2 (.DIODE(\u_crt.start_d ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
