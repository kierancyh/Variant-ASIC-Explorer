module rns_top_crt (Done,
 ...
 sky130_fd_sc_hd__and3_1 _1636_ (.A(\CU_state_dbg[2] ),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__nand2_1 _1637_ (.A(net90),
    .B(\A_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _1638_ (.A(net83),
    ...
    .VPWR(VPWR),
    .X(_0914_));
 sky130_fd_sc_hd__nand2_1 _1639_ (.A(net81),
    .B(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0915_));
 sky130_fd_sc_hd__a21boi_2 _1640_ (.A1(net81),
    .A2(net83),
    .B1_N(net90),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_4 _1643_ (.A1(_0918_),
    ...
    .VPWR(VPWR),
    .Y(_0919_));
 sky130_fd_sc_hd__or2_1 _1644_ (.A(net88),
    .B(_0916_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_4 _1660_ (.A(_0914_),
    ...
    .VPWR(VPWR),
    .Y(_0936_));
 sky130_fd_sc_hd__a31oi_4 _1661_ (.A1(net237),
    .A2(_0935_),
    .A3(_0936_),
    .B1(_0889_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _1669_ (.A1(_0944_),
    ...
    .VPWR(VPWR),
    .X(_0945_));
 sky130_fd_sc_hd__nor2_2 _1670_ (.A(net223),
    .B(net230),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _1672_ (.A1(_0937_),
    ...
    .VPWR(VPWR),
    .Y(_0948_));
 sky130_fd_sc_hd__a21bo_4 _1673_ (.A1(net226),
    .A2(_0890_),
    .B1_N(_0945_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _1676_ (.A(_0951_),
    ...
    .VPWR(VPWR),
    .Y(_0952_));
 sky130_fd_sc_hd__xnor2_4 _1677_ (.A(net229),
    .B(\A_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a2bb2o_4 _1683_ (.A1_N(_0891_),
    ...
    .VPWR(VPWR),
    .X(_0959_));
 sky130_fd_sc_hd__xnor2_4 _1684_ (.A(net238),
    .B(_0959_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _1759_ (.A1(_1021_),
    ...
    .VPWR(VPWR),
    .Y(_1032_));
 sky130_fd_sc_hd__or2_4 _1760_ (.A(_1027_),
    .B(_1032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _1806_ (.A(\A_reg[4] ),
    ...
    .VPWR(VPWR),
    .Y(_1079_));
 sky130_fd_sc_hd__or2_4 _1807_ (.A(\A_reg[3] ),
    .B(_1079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _1825_ (.A0(_1097_),
    ...
    .VPWR(VPWR),
    .X(_1098_));
 sky130_fd_sc_hd__a21oi_4 _1826_ (.A1(_1093_),
    .A2(_1096_),
    .B1(_1098_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1843_ (.A1(_1011_),
    ...
    .VPWR(VPWR),
    .Y(_1113_));
 sky130_fd_sc_hd__o21a_1 _1844_ (.A1(net80),
    .A2(_0917_),
    .B1(_0924_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _1845_ (.A(net77),
    ...
    .VPWR(VPWR),
    .X(_1115_));
 sky130_fd_sc_hd__a211o_1 _1846_ (.A1(net77),
    .A2(_1114_),
    .B1(_1112_),
    .C1(_1011_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1903_ (.A(net56),
    ...
    .VPWR(VPWR),
    .Y(_1168_));
 sky130_fd_sc_hd__a21boi_1 _1904_ (.A1(net63),
    .A2(net60),
    .B1_N(net66),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _1912_ (.A_N(\B_reg[14] ),
    ...
    .VPWR(VPWR),
    .Y(_1177_));
 sky130_fd_sc_hd__and4b_1 _1913_ (.A_N(net63),
    .B(net60),
    .C(net55),
    .D(net66),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1178_));
 sky130_fd_sc_hd__a31o_1 _1914_ (.A1(net63),
    .A2(_1174_),
    .A3(_1176_),
    .B1(_1178_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1970_ (.A1(_1228_),
    ...
    .VPWR(VPWR),
    .X(_1235_));
 sky130_fd_sc_hd__xnor2_2 _1971_ (.A(net280),
    .B(_1235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _1998_ (.A(_1259_),
    ...
    .VPWR(VPWR),
    .Y(_1260_));
 sky130_fd_sc_hd__o211ai_1 _1999_ (.A1(net61),
    .A2(_1259_),
    .B1(_1257_),
    .C1(_1176_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1261_));
 sky130_fd_sc_hd__or2_1 _2000_ (.A(net61),
    .B(_1255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _2007_ (.A(_0900_),
    ...
    .VPWR(VPWR),
    .X(_1269_));
 sky130_fd_sc_hd__xor2_2 _2008_ (.A(net134),
    .B(_1267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_4 _2011_ (.A1(_1269_),
    ...
    .VPWR(VPWR),
    .X(_1273_));
 sky130_fd_sc_hd__nor2_1 _2012_ (.A(net135),
    .B(_1273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1274_));
 sky130_fd_sc_hd__mux2_1 _2013_ (.A0(net135),
    .A1(_1274_),
    .S(_1270_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2ai_1 _2014_ (.A1_N(_1267_),
    ...
    .VPWR(VPWR),
    .Y(_1276_));
 sky130_fd_sc_hd__nand2_1 _2015_ (.A(net135),
    .B(_1272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _2095_ (.A0(\b_r1[2] ),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__nand2_1 _2096_ (.A(net60),
    .B(_1177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _2098_ (.A(_0898_),
    ...
    .VPWR(VPWR),
    .X(_1357_));
 sky130_fd_sc_hd__or3b_1 _2099_ (.A(net66),
    .B(net60),
    .C_N(net63),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1358_));
 sky130_fd_sc_hd__o21ai_1 _2100_ (.A1(net63),
    .A2(_1176_),
    .B1(_1358_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _2150_ (.A1(\b_r0[1] ),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__a21o_1 _2151_ (.A1(\A_reg[14] ),
    .A2(\A_reg[15] ),
    .B1(\A_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_4 _2158_ (.A1_N(_0923_),
    ...
    .VPWR(VPWR),
    .X(_1415_));
 sky130_fd_sc_hd__inv_2 _2159_ (.A(net97),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2164_ (.A(\A_reg[10] ),
    ...
    .VPWR(VPWR),
    .Y(_1421_));
 sky130_fd_sc_hd__nand2_1 _2165_ (.A(net95),
    .B(_1415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a2bb2o_4 _2168_ (.A1_N(_1417_),
    ...
    .VPWR(VPWR),
    .X(_1425_));
 sky130_fd_sc_hd__nand2b_1 _2169_ (.A_N(net95),
    .B(_1414_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_4 _2171_ (.A1(_1425_),
    ...
    .VPWR(VPWR),
    .X(_1428_));
 sky130_fd_sc_hd__a21oi_1 _2172_ (.A1(net86),
    .A2(_1421_),
    .B1(_1419_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2173_ (.A1(_1419_),
    ...
    .VPWR(VPWR),
    .X(_1430_));
 sky130_fd_sc_hd__xnor2_4 _2174_ (.A(_1428_),
    .B(_0889_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _2176_ (.A(_1428_),
    ...
    .VPWR(VPWR),
    .X(_1433_));
 sky130_fd_sc_hd__a21oi_4 _2177_ (.A1(_1428_),
    .A2(\A_reg[10] ),
    .B1(_1420_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_4 _2179_ (.A1_N(_1433_),
    ...
    .VPWR(VPWR),
    .X(_1436_));
 sky130_fd_sc_hd__nand2_1 _2180_ (.A(net91),
    .B(_1436_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1437_));
 sky130_fd_sc_hd__a21oi_1 _2181_ (.A1(net99),
    .A2(_1427_),
    .B1(_1424_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_4 _2195_ (.A1(_1450_),
    ...
    .VPWR(VPWR),
    .X(_1452_));
 sky130_fd_sc_hd__and2_1 _2196_ (.A(net93),
    .B(_1452_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_4 _2285_ (.A(\A_reg[0] ),
    ...
    .VPWR(VPWR),
    .Y(_1542_));
 sky130_fd_sc_hd__and2_1 _2286_ (.A(net301),
    .B(_0911_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2322_ (.A(_1562_),
    ...
    .VPWR(VPWR),
    .Y(_1575_));
 sky130_fd_sc_hd__and2_1 _2323_ (.A(net76),
    .B(_1575_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2336_ (.A(_1579_),
    ...
    .VPWR(VPWR),
    .Y(_1589_));
 sky130_fd_sc_hd__a21oi_2 _2337_ (.A1(net57),
    .A2(_1589_),
    .B1(_0902_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _2343_ (.A1(_1587_),
    ...
    .VPWR(VPWR),
    .X(_1596_));
 sky130_fd_sc_hd__a22o_1 _2344_ (.A1(_1593_),
    .A2(net69),
    .B1(_1596_),
    .B2(_1584_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _2655_ (.A(\a_r3[3] ),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__xnor2_1 _2656_ (.A(net293),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _2658_ (.A_N(_0393_),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__or3b_1 _2659_ (.A(net297),
    .B(_0393_),
    .C_N(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__xnor2_1 _2660_ (.A(net298),
    .B(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0400_));
 sky130_fd_sc_hd__nand2_1 _2661_ (.A(net301),
    .B(\a_r3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2667_ (.A(\OpSel_reg[0] ),
    ...
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__o211a_1 _2668_ (.A1(net292),
    .A2(_0395_),
    .B1(_0406_),
    .C1(\OpSel_reg[0] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _2671_ (.A(\a_r3[1] ),
    ...
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__nand2_1 _2672_ (.A(net304),
    .B(\b_r3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__o21a_1 _2673_ (.A1(net303),
    .A2(\b_r3[1] ),
    .B1(_0384_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _2676_ (.A1(_0384_),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__o211a_1 _2677_ (.A1(net294),
    .A2(_0186_),
    .B1(_0414_),
    .C1(_0416_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _2696_ (.A_N(_0433_),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__nand2_1 _2697_ (.A(net302),
    .B(net291),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_4 _2877_ (.A1(\u_crt.r3[1] ),
    ...
    .VPWR(VPWR),
    .X(_0565_));
 sky130_fd_sc_hd__nor2_4 _2878_ (.A(net111),
    .B(_0565_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_4 _2880_ (.A(\u_crt.r3[3] ),
    ...
    .VPWR(VPWR),
    .X(_0568_));
 sky130_fd_sc_hd__a21oi_2 _2881_ (.A1(net112),
    .A2(\u_crt.r3[3] ),
    .B1(net102),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_4 _2886_ (.A1(\u_crt.r3[1] ),
    ...
    .VPWR(VPWR),
    .Y(_0574_));
 sky130_fd_sc_hd__a21boi_1 _2887_ (.A1(net121),
    .A2(_0566_),
    .B1_N(_0574_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_4 _2892_ (.A(_0565_),
    ...
    .VPWR(VPWR),
    .Y(_0580_));
 sky130_fd_sc_hd__nor2_4 _2893_ (.A(_0580_),
    .B(net109),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0581_));
 sky130_fd_sc_hd__xnor2_2 _2894_ (.A(net146),
    .B(net107),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _2902_ (.A(_0588_),
    ...
    .VPWR(VPWR),
    .X(_0590_));
 sky130_fd_sc_hd__nand2_4 _2903_ (.A(_0574_),
    .B(_0581_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _2924_ (.A(_0562_),
    ...
    .VPWR(VPWR),
    .X(_0612_));
 sky130_fd_sc_hd__xor2_4 _2925_ (.A(_0611_),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _2928_ (.A(_0613_),
    ...
    .VPWR(VPWR),
    .Y(_0616_));
 sky130_fd_sc_hd__xor2_1 _2929_ (.A(net113),
    .B(_0614_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_4 _2968_ (.A(_0655_),
    ...
    .VPWR(VPWR),
    .X(_0656_));
 sky130_fd_sc_hd__nand2_1 _2969_ (.A(net152),
    .B(_0655_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_4 _2975_ (.A(_0646_),
    ...
    .VPWR(VPWR),
    .Y(_0663_));
 sky130_fd_sc_hd__nor2_1 _2976_ (.A(net105),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2978_ (.A(_0564_),
    ...
    .VPWR(VPWR),
    .Y(_0666_));
 sky130_fd_sc_hd__or3_1 _2979_ (.A(net106),
    .B(_0607_),
    .C(_0666_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _2993_ (.A(_0563_),
    ...
    .VPWR(VPWR),
    .Y(_0681_));
 sky130_fd_sc_hd__xor2_2 _2994_ (.A(net105),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3010_ (.A(_0695_),
    ...
    .VPWR(VPWR),
    .Y(_0698_));
 sky130_fd_sc_hd__nor4_1 _3011_ (.A(net120),
    .B(_0568_),
    .C(_0569_),
    .D(_0579_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0699_));
 sky130_fd_sc_hd__or2_4 _3012_ (.A(net141),
    .B(_0579_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0700_));
 sky130_fd_sc_hd__o31a_1 _3013_ (.A1(net119),
    .A2(_0568_),
    .A3(_0569_),
    .B1(_0579_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _3145_ (.A(_0805_),
    ...
    .VPWR(VPWR),
    .Y(_0833_));
 sky130_fd_sc_hd__xnor2_2 _3146_ (.A(net151),
    .B(_0833_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3154_ (.A(_0841_),
    ...
    .VPWR(VPWR),
    .Y(_0842_));
 sky130_fd_sc_hd__a31o_1 _3155_ (.A1(net151),
    .A2(_0805_),
    .A3(_0827_),
    .B1(_0809_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(net55),
    ...
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkbuf_2 split2 (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer4 (.A(_1587_),
    ...
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(_1587_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer6 (.A(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlymetal6s2s_1 split7 (.A(\B_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__buf_1 split8 (.A(\B_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer9 (.A(\B_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__clkbuf_2 split10 (.A(\B_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(_1579_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer12 (.A(\B_reg[15] ),
    ...
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__buf_1 split13 (.A(\B_reg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(_1572_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer15 (.A(_1581_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer16 (.A(_1583_),
    ...
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer23 (.A(_1574_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__buf_4 split24 (.A(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer25 (.A(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer26 (.A(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer27 (.A(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__buf_6 split28 (.A(net94),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__buf_1 rebuffer29 (.A(\A_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__buf_4 split30 (.A(\A_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__buf_1 rebuffer31 (.A(_1440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer32 (.A(_1440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer33 (.A(_1428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 rebuffer34 (.A(\A_reg[12] ),
    ...
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__buf_1 split35 (.A(\A_reg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__buf_1 rebuffer36 (.A(\A_reg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__buf_6 split37 (.A(\A_reg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer38 (.A(_1430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer39 (.A(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer40 (.A(_1447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__buf_6 rebuffer41 (.A(\A_reg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer42 (.A(_1413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer43 (.A(_1508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__buf_2 rebuffer44 (.A(_1415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__buf_1 rebuffer45 (.A(_1504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer46 (.A(_1425_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net99));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer47 (.A(_1431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer48 (.A(net100),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer50 (.A(net102),
    ...
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__buf_1 rebuffer51 (.A(\u_crt.r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__clkbuf_2 rebuffer52 (.A(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer53 (.A(net105),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__buf_2 rebuffer54 (.A(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__buf_6 rebuffer55 (.A(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__clkbuf_2 rebuffer56 (.A(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer57 (.A(_0738_),
    ...
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer58 (.A(\u_crt.r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer59 (.A(\u_crt.r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer60 (.A(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer61 (.A(_0758_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__buf_1 rebuffer62 (.A(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__buf_1 rebuffer63 (.A(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__buf_1 rebuffer64 (.A(net144),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__buf_6 rebuffer65 (.A(net144),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__buf_1 rebuffer66 (.A(_0567_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__buf_2 rebuffer67 (.A(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer68 (.A(\u_crt.r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer80 (.A(_1260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer81 (.A(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net134));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer82 (.A(_1269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer88 (.A(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net141));
 sky130_fd_sc_hd__clkbuf_2 rebuffer89 (.A(_0762_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net142));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer90 (.A(_0760_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net143));
 sky130_fd_sc_hd__buf_8 rebuffer91 (.A(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net144));
 sky130_fd_sc_hd__buf_2 rebuffer92 (.A(_0771_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__clkbuf_2 rebuffer93 (.A(net144),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer94 (.A(net148),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer95 (.A(_0582_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net148));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer98 (.A(_0801_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net151));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer99 (.A(_0640_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer170 (.A(_0938_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net223));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer171 (.A(_0955_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer172 (.A(net224),
    ...
    .VPWR(VPWR),
    .X(net225));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer173 (.A(_0943_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net226));
 sky130_fd_sc_hd__clkbuf_1 rebuffer174 (.A(net232),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net227));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer175 (.A(net234),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net228));
 sky130_fd_sc_hd__buf_6 rebuffer176 (.A(_0950_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net229));
 sky130_fd_sc_hd__clkbuf_2 rebuffer177 (.A(_0945_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer178 (.A(net230),
    ...
    .VPWR(VPWR),
    .X(net231));
 sky130_fd_sc_hd__clkbuf_2 rebuffer179 (.A(_0932_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net232));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer180 (.A(_0929_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net233));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer181 (.A(_0950_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net234));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer182 (.A(_0919_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net235));
 sky130_fd_sc_hd__buf_6 rebuffer183 (.A(net235),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net236));
 sky130_fd_sc_hd__buf_6 rebuffer184 (.A(_0932_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net237));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer185 (.A(_0949_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net238));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer227 (.A(_1223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net280));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer238 (.A(\b_r3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net291));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer239 (.A(\b_r3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net292));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer240 (.A(net292),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net293));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer241 (.A(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer242 (.A(net294),
    ...
    .VPWR(VPWR),
    .X(net295));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer243 (.A(\b_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net296));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer244 (.A(net296),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net297));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer245 (.A(net297),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net298));
 sky130_fd_sc_hd__dlygate4sd3_1 rebuffer246 (.A(\b_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net299));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer247 (.A(\b_r3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net300));
 sky130_fd_sc_hd__clkbuf_2 split248 (.A(\a_r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net301));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer249 (.A(\a_r3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net302));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer250 (.A(\a_r3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net303));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer251 (.A(net303),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1754__A1 (.DIODE(\A_reg[10] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2177__A2 (.DIODE(\A_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_split30_A (.DIODE(\A_reg[13] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_rebuffer29_A (.DIODE(\A_reg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1836__B1 (.DIODE(\a_r1[0] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split248_A (.DIODE(\a_r3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA__1638__A (.DIODE(net83),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__1734__A2 (.DIODE(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_rebuffer27_A (.DIODE(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_split30_X (.DIODE(net83),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2661__A (.DIODE(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_rebuffer241_A (.DIODE(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2675__B2 (.DIODE(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2646__B (.DIODE(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA__2286__A (.DIODE(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_split248_X (.DIODE(net301),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
