...
module rrns_cu (
    ...
    output reg        Corr_Start,
    output reg        Out_EN
);

    // IDLE -> LOAD -> ENCODE -> ALU -> RECON -> CORR -> OUT -> DONE
    localparam [2:0]
        S_IDLE   = 3'd0,
        S_LOAD   = 3'd1,
        S_ENCODE = 3'd2,
    ...
    always @* begin
        ...
        case (state)
            ...
            S_RECON:  if (recon_done_sel) next_state = S_CORR;
            S_CORR:   if (Corr_Done)      next_state = S_OUT;
